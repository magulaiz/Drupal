...
trait BasicAuthTestTrait {
   ...
   */
  protected function basicAuthGet($path, string $username, string $password, array $options = []) {
   ...
   */
  protected function getBasicAuthHeaders(string $username, string $password) {
