...
class DateTimeCustomFormatter extends DateTimeFormatterBase {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    $form['date_format'] = [
      ...
      '#description' => $this->t('See <a href="!url">the documentation for PHP date formats</a>.', ['!url' => 'https://www.php.net/manual/datetime.format.php#refsect1-datetime.format-parameters']),
