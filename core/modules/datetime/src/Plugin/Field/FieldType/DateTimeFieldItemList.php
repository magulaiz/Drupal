    ...
    if (empty($this->getFieldDefinition()->getDefaultValueCallback())) {
      ...
      $element = [
        ...
        'default_date' => [
          ...
          '#description' => t("Describe a time by reference to the current day, like '+90 days' (90 days from the day the field is created) or '+1 Saturday' (the next Saturday). See <a href=\"https://php.net/manual/function.strtotime.php\">strtotime</a> for more details."),
