...
class BlockContentTestHooks
{
    ...
    public function blockContentView(array &$build, \Drupal\block_content\Entity\BlockContent $block_content, $view_mode)
    {
        // Add extra content.
    ...
    public function blockContentPresave(\Drupal\block_content\Entity\BlockContent $block_content)
    {
    ...
    public function blockContentUpdate(\Drupal\block_content\Entity\BlockContent $block_content)
    {
    ...
    public function blockContentInsert(\Drupal\block_content\Entity\BlockContent $block_content)
    {
