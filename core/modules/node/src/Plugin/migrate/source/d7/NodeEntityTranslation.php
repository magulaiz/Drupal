...
class NodeEntityTranslation extends FieldableEntity {
  ...
  public function query() {
    ...
    $query->innerJoin('node', 'n', $query->joinCondition()->compare('n.nid', 'et.entity_id'));
    $query->innerJoin('node_revision', 'nr', $query->joinCondition()->compare('nr.vid', 'et.revision_id'));
