...
class MigrateNodeTypeTest extends MigrateDrupal6TestBase {
  ...
  public function testNodeType(): void {
    ...
    $this->assertSame(NodeTypeInterface::PREVIEW_OPTIONAL, $node_type_page->getPreviewMode());
    ...
    $this->assertSame(NodeTypeInterface::PREVIEW_OPTIONAL, $node_type_story->getPreviewMode());
    ...
    $this->assertSame(NodeTypeInterface::PREVIEW_OPTIONAL, $node_type_event->getPreviewMode());
