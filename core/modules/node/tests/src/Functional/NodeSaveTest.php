...
class NodeSaveTest extends NodeTestBase {
  ...
  public function testTimestamps() {
    ...
    $this->assertEquals($this->testRequestTime, $node->getCreatedTime(), 'Creating a node sets default "created" timestamp.');
    $this->assertEquals($this->testRequestTime, $node->getChangedTime(), 'Creating a node sets default "changed" timestamp.');
