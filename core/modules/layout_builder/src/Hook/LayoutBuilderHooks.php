  ...
  public function help($route_name, RouteMatchInterface $route_match): string {
    ...
    if ($route_match->getRouteObject()->getOption('_layout_builder')) {
      ...
      if (\Drupal::currentUser()->hasPermission('administer blocks')) {
        $output .= '<p>' . $this->t('To manage other areas of the page, use the <a href="@block-ui">block administration page</a>.', [
          '@block-ui' => Url::fromRoute('block.admin_display')->toString(),
        ]) . '</p>';
      }
      else {
