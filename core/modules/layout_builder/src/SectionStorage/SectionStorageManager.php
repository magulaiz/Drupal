...
use Drupal\layout_builder\Annotation\SectionStorage as SectionStorageAnnotation;
use Drupal\layout_builder\Attribute\SectionStorage as SectionStorageAttribute;
...
class SectionStorageManager extends DefaultPluginManager implements SectionStorageManagerInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler, ContextHandlerInterface $context_handler) {
    parent::__construct('Plugin/SectionStorage', $namespaces, $module_handler, SectionStorageInterface::class, SectionStorageAttribute::class, SectionStorageAnnotation::class);
