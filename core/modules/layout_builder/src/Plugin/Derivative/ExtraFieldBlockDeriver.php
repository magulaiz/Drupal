...
class ExtraFieldBlockDeriver extends DeriverBase implements ContainerDeriverInterface {
   ...
   */
  public function __construct(protected EntityFieldManagerInterface $entityFieldManager, protected EntityTypeManagerInterface $entityTypeManager, protected EntityTypeBundleInfoInterface $entityTypeBundleInfo, protected EntityTypeRepositoryInterface $entityTypeRepository)
  {
  }
