  ...
  protected function buildAdministrativeSection(SectionStorageInterface $section_storage, $delta) {
    ...
    foreach ($layout_definition->getRegions() as $region => $region_info) {
      $build["section-$delta-region-$region"] = [
        ...
        '#attributes' => [
          'data-section-region-delta' => "$delta|$region",
        ],
        'operations' => [
          '#type' => 'operations',
      ...
      foreach ($components as $component) {
        ...
        $build["section-$delta-region-$region-uuid-$uuid"] = [
          'label' => [
            '#markup' => "$label ($plugin_id)",
          ],
          '#attributes' => [
            'data-section-region-block-delta' => "$delta|$region|$plugin_id",
          ],
          'operations' => [
            '#type' => 'operations',
