...
class MoveBlockController implements ContainerInjectionInterface {
   ...
   *   An AJAX response.
   */
  public function build(SectionStorageInterface $section_storage, int $delta_from, int $delta_to, string $region_to, string $block_uuid, $preceding_block_uuid = NULL) {
