...
class LayoutBuilderInstallTest extends LayoutBuilderCompatibilityTestBase {
  ...
  public function testCompatibility(): void {
    ...
    $expected_fields = [
      'field field--name-name field--type-string field--label-hidden field--single-value-field field--has-single-item field--items-count-1',
      'field field--name-test-field-display-configurable field--type-boolean field--label-above field--single-value-field field--has-single-item field--items-count-1',
      'clearfix text-formatted field field--name-test-display-configurable field--type-text field--label-above field--single-value-field field--has-single-item field--items-count-1',
      'clearfix text-formatted field field--name-test-display-non-configurable field--type-text field--label-above field--single-value-field field--has-single-item field--items-count-1',
    ...
    $new_expected_fields = [
      ...
      'clearfix text-formatted field field--name-test-field-display-post-install field--type-text field--label-above field--single',
      'clearfix text-formatted field field--name-test-display-non-configurable field--type-text field--label-above field--single',
      'clearfix text-formatted field field--name-test-display-multiple field--type-text field--label-above field--multiple',
    ];
    $this->assertFieldAttributes($this->entity, $new_expected_fields);
