...
class LayoutSectionStorageParamConverterTest extends UnitTestCase {
  ...
  public function testConvert() {
    ...
    $converter = new LayoutSectionStorageParamConverter($layout_tempstore_repository->reveal(), $section_storage_manager->reveal());
   ...
   * @covers ::convert
   */
  public function testConvertNoTempstore() {
    $layout_tempstore_repository = $this->prophesize(LayoutTempstoreRepositoryInterface::class);
    $section_storage_manager = $this->prophesize(SectionStorageManagerInterface::class);
    $converter = new LayoutSectionStorageParamConverter($layout_tempstore_repository->reveal(), $section_storage_manager->reveal());
    ...
    $value = 'some_value';
    $definition = ['layout_builder_section_storage' => TRUE];
    $name = 'the_parameter_name';
    $defaults = ['section_storage_type' => 'my_type'];
