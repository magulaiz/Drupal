...
class ComposerUtility {
  ...
  public function __construct(object $composer) {
    // @todo Remove this in https://www.drupal.org/project/auto_updates/issues/3321474.
    if (self::$triggerConstructorDeprecation) {
      @trigger_error(__METHOD__ . '() is deprecated in auto_updates:8.x-2.5 and will be removed in auto_updates:3.0.0. Use ' . __CLASS__ . '::createForDirectory() instead. See https://www.drupal.org/node/3314137.', E_USER_DEPRECATED);
    }
    ...
    // @todo Update in https://www.drupal.org/project/auto_updates/issues/3321474
    // @todo Update in https://www.drupal.org/project/auto_updates/issues/3321476
