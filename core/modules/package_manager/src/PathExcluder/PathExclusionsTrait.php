  ...
  protected function excludeInWebRoot(StageEvent $event, array $paths): void {
    ...
    foreach ($paths as $path) {
      ...
      if ($event instanceof CollectIgnoredPathsEvent) {
        ...
        @trigger_error('Passing ' . get_class($event) . ' to ' . __METHOD__ . ' is deprecated in auto_updates:8.x-2.5 and will be removed in auto_updates:3.0.0. See https://www.drupal.org/node/3317862.', E_USER_DEPRECATED);
