...
trait ExcludedPathsTrait {
  ...
  public function excludePath(string $path): void {
    @trigger_error(__METHOD__ . '() is deprecated in auto_updates:8.x-2.5 and removed in auto_updates:3.0.0. Use ' . CollectIgnoredPathsEvent::class . ' instead. See https://www.drupal.org/node/3317862.', E_USER_DEPRECATED);
