...
class PreCreateEvent extends PreOperationStageEvent {
  ...
  public function __construct(Stage $stage, array $ignored_paths = NULL) {
    if ($ignored_paths === NULL) {
      @trigger_error('Calling ' . __METHOD__ . '() without the $ignored_paths argument is deprecated in auto_updates:8.x-2.5 and will be removed in auto_updates:3.0.0. See https://www.drupal.org/node/3317862.', E_USER_DEPRECATED);
      $ignored_paths = [];
    }
