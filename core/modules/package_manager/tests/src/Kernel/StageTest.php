...
class StageTest extends PackageManagerKernelTestBase {
  ...
  public function testConstructorDeprecations(): void {
    ...
    $this->expectDeprecation('Calling Drupal\package_manager\Stage::__construct() with the $config_factory argument is deprecated in auto_updates:8.x-2.6 and will be removed in auto_updates:3.0.0. See https://www.drupal.org/node/3325718.');
    ...
    $this->expectDeprecation('Overriding Drupal\package_manager\Stage::TEMPSTORE_METADATA_KEY is deprecated in auto_updates:8.x-2.5 and will not be possible in auto_updates:3.0.0. There is no replacement. See https://www.drupal.org/node/3317450.');
    $this->expectDeprecation('Overriding Drupal\package_manager\Stage::TEMPSTORE_LOCK_KEY is deprecated in auto_updates:8.x-2.5 and will not be possible in auto_updates:3.0.0. There is no replacement. See https://www.drupal.org/node/3317450.');
