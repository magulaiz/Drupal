...
class StageEventsTest extends PackageManagerKernelTestBase implements EventSubscriberInterface {
  ...
  public function testDeprecations(): void {
    ...
    $this->expectDeprecation('Calling ' . StatusCheckEvent::class . '::__construct() without the $ignored_paths argument is deprecated in auto_updates:8.x-2.5 and will be removed in auto_updates:3.0.0. See https://www.drupal.org/node/3317862.');
    $this->expectDeprecation(ExcludedPathsTrait::class . '::excludePath() is deprecated in auto_updates:8.x-2.5 and removed in auto_updates:3.0.0. Use ' . CollectIgnoredPathsEvent::class . ' instead. See https://www.drupal.org/node/3317862.');
    (new StatusCheckEvent($stage))->excludePath('/junk/drawer');

    $this->expectDeprecation('Calling ' . PreCreateEvent::class . '::__construct() without the $ignored_paths argument is deprecated in auto_updates:8.x-2.5 and will be removed in auto_updates:3.0.0. See https://www.drupal.org/node/3317862.');
    $this->expectDeprecation(ExcludedPathsTrait::class . '::excludePath() is deprecated in auto_updates:8.x-2.5 and removed in auto_updates:3.0.0. Use ' . CollectIgnoredPathsEvent::class . ' instead. See https://www.drupal.org/node/3317862.');
    (new PreCreateEvent($stage))->excludePath('/junk/drawer');

    $this->expectDeprecation('Calling ' . PreApplyEvent::class . '::__construct() without the $ignored_paths argument is deprecated in auto_updates:8.x-2.5 and will be removed in auto_updates:3.0.0. See https://www.drupal.org/node/3317862.');
    $this->expectDeprecation(ExcludedPathsTrait::class . '::excludePath() is deprecated in auto_updates:8.x-2.5 and removed in auto_updates:3.0.0. Use ' . CollectIgnoredPathsEvent::class . ' instead. See https://www.drupal.org/node/3317862.');
