  ...
  public function providerException(): array {
    ...
    return [
      ...
      'aaa_auto_updates_test(not in active), update to unsupported branch' => [
        [
          'aaa_auto_updates_test' => "$release_fixture_folder/aaa_auto_updates_test.7.0.1.xml",
        ],
        FALSE,
        [
          ...
          'version' => '7.0.1-dev',
          'type' => 'drupal-module',
          'install_path' => '../../modules/aaa_auto_updates_test',
        ],
        [
          ValidationResult::createError([t('aaa_auto_updates_test (drupal/aaa_auto_updates_test) 7.0.1-dev')], $summary),
        ],
      ],
