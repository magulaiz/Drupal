...
/**
 * Provides a basic navigation block for testing instantiation and config.
 */
#[NavigationBlock(
  id: "test_navigation_block_instantiation",
  admin_label: new TranslatableMarkup("Display message")
)]
class TestNavigationBlockInstantiation extends NavigationBlockPluginBase {
