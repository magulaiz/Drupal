...
class AliasRepository implements AliasRepositoryInterface {
  ...
  public function __construct(Connection $connection, protected ?LanguageManagerInterface $languageManager = NULL) {
    ...
    if (!$languageManager) {
      @trigger_error('Calling AliasRepository::__construct() without the $languageManager argument is deprecated in drupal:10.4.0 and the $languageManager argument will be required in drupal:12.0.0. See https://www.drupal.org/node/3108585', E_USER_DEPRECATED);
