...
class EditorTestHooks
{
    ...
    public function editorXssFilterAlter(&$editor_xss_filter_class, \Drupal\filter\FilterFormatInterface $format, ?\Drupal\filter\FilterFormatInterface $original_format = \NULL)
    {
        // Allow tests to enable or disable this alter hook.
     ...
     */
    #[Hook('file_presave')]
    public function filePresave(\Drupal\file\FileInterface $file)
    {
