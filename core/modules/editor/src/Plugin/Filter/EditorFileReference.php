 ...
 *   description = @Translation("Ensures that the latest versions of images uploaded via a Text Editor are displayed, along with their dimensions, and appends a lazy loading attribute to those images."),
