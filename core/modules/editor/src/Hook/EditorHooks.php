...
class EditorHooks {
  ...
  public function formFilterAdminOverviewAlter(&$form, FormStateInterface $form_state) {
  ...
  public function formFilterFormatFormAlter(&$form, FormStateInterface $form_state) {
