...
class Ckeditor5Hooks {
  ...
  public function moduleImplementsAlter(&$implementations, $hook) {
    ...
    if ($hook === 'form_alter' && isset($implementations['ckeditor5']) && isset($implementations['editor'])) {
      ...
      $implementations = array_slice($implementations, 0, $offset, TRUE) + ['ckeditor5' => $group] + array_slice($implementations, $offset, NULL, TRUE);
    }
  }
  ...
  public function formFilterFormatFormAlter(array &$form, FormStateInterface $form_state, $form_id) {
