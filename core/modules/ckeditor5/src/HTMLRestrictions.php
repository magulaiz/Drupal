...
final class HTMLRestrictions {
  ...
  private function _merge_config_arrays(array $array1, array $array2): array {
    ...
    if (count($common_keys) === 0) {
      ...
      // For all the distinct tags, append them to the result.
      ...
      foreach ($common_keys as $key) {
        ...
        elseif ($value1_is_bool || $value2_is_bool) {
        ...
        // Process tag attributes configuration.
        elseif (is_array($value1) && is_array($value2)) {
          $union[$key] = $this->_merge_config_arrays($value1, $value2);
        }
      }
    }
  ...
  public function merge(HTMLRestrictions $other): HTMLRestrictions {
    $union = $this->_merge_config_arrays($this->elements, $other->elements);
