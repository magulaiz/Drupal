...
import DrupalMediaResizeEditing from './drupalmediaresizeediting';
 ...
 */
export default class DrupalMediaResizeButtons extends Plugin {
	/**
	 * @inheritDoc
	 */
	static get requires() {
		return [ DrupalMediaResizeEditing ];
	}
   ...
   *  @see ckeditor.ckeditor5.yml
	 ...
	 * @param {module:image/imageresize/resizemediacommand~DrupalMediaResizeCommand} command The resize image command.
