...
import DrupalMediaResizeCommand from './drupalmediaresizecommand';

export default class DrupalMediaResizeEditing extends Plugin {
	...
	init() {
		...
		const resizeMediaCommand = new DrupalMediaResizeCommand( editor );
