...
/* cspell:words mediaimagetitlecommand drupalmediametadatarepository insertdrupalmediacommand */

import { Plugin } from 'ckeditor5/src/core';
import { Template } from 'ckeditor5/src/ui';
import MediaImageTitleCommand from './mediaimagetitlecommand';
import DrupalMediaMetadataRepository from '../drupalmediametadatarepository';
import { METADATA_ERROR } from './utils';

/**
 * @module drupalMedia/mediaimagetitle/mediaimagetitleediting
 */

/**
 * The media title text editing plugin.
 */
export default class MediaImageTitleEditing extends Plugin {
  /**
   * @inheritdoc
   */
  static get requires() {
  ...
  init() {
    ...
    editor.commands.add(
      'mediaImageTitle',
      new MediaImageTitleCommand(this.editor),
    );
  }
}
