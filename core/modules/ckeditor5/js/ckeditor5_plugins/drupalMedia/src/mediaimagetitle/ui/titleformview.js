...
export default class TitleFormView extends View {
  ...
  constructor(locale) {
     ...
     */
    this.set('defaultTitle', undefined);
     ...
     */
    this.defaultTitleView = this._createDefaultTitleView();
    ...
    this.setTemplate({
      ...
      attributes: {
        class: ['ck', 'ck-alternative-text-form', 'ck-vertical-form'],
        tabindex: '-1',
      },

      children: [
        this.defaultTitleView,
        this.labeledInput,
        this.saveButtonView,
  ...
  _createLabeledInputView() {
    ...
    labeledInput.label = Drupal.t('Image title text');

    return labeledInput;
  }

  /**
   * Creates a default title view.
   *
   * @return {module:ui/template~Template}
   *   A template for default title view.
   * @private
   */
  _createDefaultTitleView() {
    ...
    return new Template({
      ...
      attributes: {
        class: [
          ...
          bind.if('defaultTitle', 'ck-hidden', (value) => !value),
        ],
      },
      children: [
        {
