...
export default class LinkTextAlternativeFormView extends View {
  /**
   * @inheritdoc
   */
  constructor(locale) {
     ...
     */
    this.set('defaultLinkText', undefined);
     ...
     */
    this.defaultLinkTextView = this._createDefaultLinkTextView();
  ...
  _createLabeledInputView() {
    ...
    labeledInput.label = Drupal.t('Alternative link text override');
   ...
   * @private
   */
  _createDefaultLinkTextView() {
    const bind = Template.bind(this, this);
    return new Template({
      tag: 'div',
      attributes: {
        class: [
          'ck-media-alternative-text-form__default-data-link-text',
          bind.if('defaultLinkText', 'ck-hidden', (value) => !value),
        ],
      },
      children: [
        {
