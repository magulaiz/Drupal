...
/* cspell:words medialinktextalternativecommand drupalmediametadatarepository insertdrupalmediacommand */

import { Plugin } from 'ckeditor5/src/core';
import { Template } from 'ckeditor5/src/ui';
import MediaLinkTextAlternativeCommand from './medialinktextalternativecommand';
import DrupalMediaMetadataRepository from '../drupalmediametadatarepository';
import { METADATA_ERROR } from './utils';

/**
 * @module drupalMedia/medialinktextalternative/medialinktextalternativeediting
 */

/**
 * The media image text alternative editing plugin.
 */
export default class MediaLinkTextAlternativeEditing extends Plugin {
  /**
   * @inheritdoc
   */
  static get requires() {
  ...
  static get pluginName() {
    return 'MediaLinkTextAlternativeEditing';
  }
  ...
  init() {
    ...
    editor.commands.add(
      ...
      new MediaLinkTextAlternativeCommand(this.editor),
    );
  }
}
