  ...
  return (dispatcher) => {
    dispatcher.on(
      ...
      (evt, data, conversionApi) => {
        ...
        // eslint-disable-next-line no-restricted-syntax
        for (const [key, val] of (0,delegated_utilsfrom_dll_reference_CKEditor5.toMap)(decorator.attributes)) {
  ...
  return (dispatcher) => {
    dispatcher.on(
      ...
      (evt, data, conversionApi) => {
        ...
        const matcher = new delegated_enginefrom_dll_reference_CKEditor5.Matcher(decorator._createPattern());
