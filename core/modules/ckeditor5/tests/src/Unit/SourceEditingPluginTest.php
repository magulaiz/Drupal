...
class SourceEditingPluginTest extends UnitTestCase {
  ...
  public function testGetDynamicPluginConfig(array $configuration): void {
    ...
    $this->assertContains(['name' => 'a', 'attributes' => [['key' => 'hreflang', 'value' => TRUE]]], $config['htmlSupport']['allow']);
    $this->assertContains(['name' => 'blockquote', 'attributes' => [['key' => 'cite', 'value' => TRUE]]], $config['htmlSupport']['allow']);
    $this->assertContains(['name' => 'ul', 'attributes' => [['key' => 'type', 'value' => TRUE]]], $config['htmlSupport']['allow']);
    $this->assertContains(['name' => 'ol', 'attributes' => [['key' => 'start', 'value' => TRUE], ['key' => 'type', 'value' => TRUE]]], $config['htmlSupport']['allow']);
    $this->assertContains(['name' => 'h2', 'attributes' => [['key' => 'id', 'value' => TRUE]]], $config['htmlSupport']['allow']);
    $this->assertContains(['name' => 'h3', 'attributes' => [['key' => 'id', 'value' => TRUE]]], $config['htmlSupport']['allow']);
    $this->assertContains(['name' => 'h4', 'attributes' => [['key' => 'id', 'value' => TRUE]]], $config['htmlSupport']['allow']);
    $this->assertContains(['name' => 'h5', 'attributes' => [['key' => 'id', 'value' => TRUE]]], $config['htmlSupport']['allow']);
    $this->assertContains(['name' => 'h6', 'attributes' => [['key' => 'id', 'value' => TRUE]]], $config['htmlSupport']['allow']);
  }
