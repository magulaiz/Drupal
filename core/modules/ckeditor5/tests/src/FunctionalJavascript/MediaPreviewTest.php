...
class MediaPreviewTest extends MediaTestBase {
  ...
  /**
   * Ensure media preview can be fetched regardless of embed's markup length.
   */
  public function testMediaEmbedLongMarkup() {
    $this->drupalLogin($this->adminUser);
    // Insert a media embed that contains a long alt text (5000+ chars) as an
    // example of why GET is the wrong method to fetch previews.
    $this->host->set('body', [
      'value' => '<drupal-media data-entity-type="media" data-entity-uuid="' . $this->media->uuid() . '" alt="This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead. This is a very long alt text to prove that using GET for fetching previews is not the right method and POST should be used instead."></drupal-media>',
      'format' => 'test_format',
    ]);
    ...
    $assert_session = $this->assertSession();
    $assert_session->waitForElementVisible('css', '.ck-widget.drupal-media');
    $this->assertNotEmpty($assert_session->waitForElementVisible('css', 'img[src*="image-test.png"]', 1000));
    $assert_session->elementExists('css', '.ck-widget.drupal-media .media');
    $this->assertEmpty($assert_session->waitForText('An error occurred while trying to preview the media. Save your work and reload this page.'));
  }
