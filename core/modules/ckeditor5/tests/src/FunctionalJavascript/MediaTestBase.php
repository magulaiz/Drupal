    ...
    FilterFormat::create([
      ...
      'filters' => [
        'filter_html' => [
          'status' => TRUE,
          'settings' => [
            'allowed_html' => '<p> <br> <strong> <em> <a href> <drupal-media data-entity-type data-link-entity-type data-link-entity-uuid data-link-entity-metadata data-entity-uuid data-align data-view-mode data-caption alt>',
          ],
        ],
