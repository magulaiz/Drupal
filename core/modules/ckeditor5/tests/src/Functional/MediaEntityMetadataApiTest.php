    ...
    $filtered_html_format = FilterFormat::create([
      ...
      'filters' => [
        'filter_html' => [
          ...
          'weight' => -10,
          'settings' => [
            'allowed_html' => "<p> <br> <drupal-media data-entity-type data-entity-uuid data-link-entity-type data-link-entity-uuid data-link-entity-metadata data-view-mode alt>",
