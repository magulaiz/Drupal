...
class TermEntityTranslation extends FieldableEntity {
  ...
  public function query() {
    ...
    $query->innerJoin('taxonomy_term_data', 'td', $this->getDatabase()->condition('AND')->compare('td.tid', 'et.entity_id'));
    $query->innerJoin('taxonomy_vocabulary', 'tv', $this->getDatabase()->condition('AND')->compare('td.vid', 'tv.vid'));
