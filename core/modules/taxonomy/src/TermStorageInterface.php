...
interface TermStorageInterface extends ContentEntityStorageInterface {
   ...
   */
  public function loadParents(int $tid);
   ...
   */
  public function loadAllParents(int $tid);
   ...
   */
  public function loadChildren(int $tid, string $vid = NULL);
   ...
   *   vocabulary $vid.
   */
  public function loadTree(string $vid, int $parent = 0, int $max_depth = NULL, bool $load_entities = FALSE);
