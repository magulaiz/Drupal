...
class TaxonomyRevisionRevertTranslationForm extends TaxonomyRevisionRevertForm {
   ...
   *   The time service.
   */
  public function __construct(EntityStorageInterface $termStorage, DateFormatterInterface $date_formatter, LanguageManagerInterface $language_manager, TimeInterface $time) {
    parent::__construct($termStorage, $date_formatter, $time);
  ...
  protected function prepareRevertedRevision(TermInterface $revision, FormStateInterface $form_state) {
    ...
    return $this->termStorage->createRevision($translation, TRUE, $revert_untranslated_fields);
  }
