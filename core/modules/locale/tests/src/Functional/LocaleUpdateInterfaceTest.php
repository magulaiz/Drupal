...
class LocaleUpdateInterfaceTest extends LocaleUpdateBase {
  ...
  public function testInterface() {
    ...
    $status['drupal']['de']->files['local']->timestamp = $this->testRequestTime;
    ...
    $this->assertSession()->pageTextContains('Drupal core (' . $this->container->get('date.formatter')->format($this->testRequestTime, 'html_date') . ')');
