...
class LocaleTestDevelopmentReleaseHooks {
  ...
  public function localeTranslationProjectsAlter(&$projects) {
    $projects['contrib'] = ['name' => 'contrib', 'info' => ['name' => 'Contributed module', 'package' => 'Other', 'version' => '12.x-10.4-unstable11+14-dev', 'project' => 'contrib_module', 'datestamp' => '0', '_info_file_ctime' => 1442933959], 'datestamp' => '0', 'project_type' => 'module', 'project_status' => \TRUE];
  }
