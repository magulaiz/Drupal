...
class LocaleHooks {
  ...
  public function formLanguageAdminOverviewFormAlter(&$form, FormStateInterface $form_state) {
  ...
  public function formLanguageAdminAddFormAlter(&$form, FormStateInterface $form_state) {
  ...
  public function formSystemFileSystemSettingsAlter(&$form, FormStateInterface $form_state) {
