...
namespace Drupal\Tests\migrate_drupal\Unit\field\d6;

use Drupal\migrate\Plugin\MigrationInterface;
use Drupal\migrate\Row;
use Drupal\Tests\UnitTestCase;
use Drupal\migrate_drupal\Plugin\migrate\field\d6\FileField;
use Prophecy\Argument;

// cspell:ignore filefield imagefield

/**
 * @coversDefaultClass \Drupal\migrate_drupal\Plugin\migrate\field\d6\FileField
