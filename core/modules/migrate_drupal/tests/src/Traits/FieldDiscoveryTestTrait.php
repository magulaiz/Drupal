...
trait FieldDiscoveryTestTrait {
   ...
   *   (optional) The bundle.
   */
  public function assertFieldProcess(FieldDiscoveryInterface $field_discovery, MigrationPluginManagerInterface $migration_plugin_manager, string $core, string $field_plugin_method = NULL, array $expected_process = [], string $entity_type_id = NULL, string $bundle = NULL) {
    $definition = [
   ...
   *   (optional) The bundle.
   */
  public function assertFieldProcessKeys(FieldDiscoveryInterface $field_discovery, MigrationPluginManagerInterface $migration_plugin_manager, string $core, array $expected_process_keys, string $entity_type_id = NULL, string $bundle = NULL) {
    $definition = [
      'migration_tags' => ['Drupal ' . $core],
    ];
    $migration = $migration_plugin_manager->createStubMigration($definition);
   ...
   */
  public function assertSourcePlugin(string $core, string $class, array $expected_definition) {
