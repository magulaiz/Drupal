...
namespace Drupal\Tests\migrate_drupal\Kernel\Plugin\migrate\field\d7;

use Drupal\KernelTests\KernelTestBase;
use Drupal\migrate\Plugin\MigrationInterface;
use Drupal\migrate_drupal\Plugin\migrate\field\d7\LinkField;
use Prophecy\Argument;

/**
 * @coversDefaultClass \Drupal\migrate_drupal\Plugin\migrate\field\d7\LinkField
 * @group link
 */
