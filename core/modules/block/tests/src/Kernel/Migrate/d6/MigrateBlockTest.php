...
class MigrateBlockTest extends MigrateDrupal6TestBase {
  ...
  public function testBlockMigration() {
    ...
    $this->assertSame($messages[2]->message, 'Schema errors for block.block.aggregator with the following errors: block.block.aggregator:settings.block_count missing schema, block.block.aggregator:settings.feed missing schema, 0 [settings] &#039;feed&#039; is not a supported key.');
  }
