 ...
 * @internal
 */
class BlockConfigUpdater implements ContainerInjectionInterface {
  ...
  /**
   * BlockConfigUpdater constructor.
   */
  ...
  public function needsInfoStatusSettingsRemoved(BlockInterface $block): bool {
    ...
    if ($this->deprecationsEnabled && !$deprecations_triggered) {
      ...
      @trigger_error('Block content blocks with the "status" and "info" settings is deprecated in drupal:11.2.0 and will be removed in drupal:12.0.0. They were unused, so there is no replacement. Profile, module and theme provided configuration should be updated. See https://www.drupal.org/node/3499836', E_USER_DEPRECATED);
    }
