...
class Block extends ConfigEntityBase implements BlockInterface, EntityWithPluginCollectionInterface {
   ...
   * {@inheritdoc}
   */
  #[ActionMethod(adminLabel: new TranslatableMarkup('Change block region'), pluralize: FALSE)]
   ...
   * {@inheritdoc}
   */
  #[ActionMethod(adminLabel: new TranslatableMarkup('Change block weight'), pluralize: FALSE)]
