...
trait FileFieldCreationTrait {
   ...
   *   The file field.
   */
  public function createFileField(string $name, string $entity_type, string $bundle, $storage_settings = [], $field_settings = [], $widget_settings = []) {
   ...
   *   A list of widget settings that will be added to the widget defaults.
   */
  public function attachFileField(string $name, string $entity_type, string $bundle, $field_settings = [], $widget_settings = []) {
    $field = [
      'field_name' => $name,
      'label' => $name,
      'entity_type' => $entity_type,
