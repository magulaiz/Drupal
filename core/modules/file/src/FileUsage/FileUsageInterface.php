...
interface FileUsageInterface {
   ...
   */
  public function add(FileInterface $file, string $module, string $type, string $id, int $count = 1);
   ...
   *   specific object.
   */
  public function delete(FileInterface $file, string $module, string $type = NULL, string $id = NULL, int $count = 1);
