...
(function ($, Drupal) {
  ...
  function setEditModeState(editMode) {
    ...
    if (editMode) {
      ...
      closeToolbarTrays();
      $editables = $(Drupal.once('settingstray', '[data-drupal-settingstray="editable"]'));
  ...
  $(document).on('drupalContextualLinkAdded', function (event, data) {
    prepareAjaxLinks();
    Drupal.once('settings_tray.edit_mode_init', 'body').forEach(function () {
  ...
  Drupal.behaviors.toggleEditMode = {
    attach: function attach() {
      $(Drupal.once('settingstray', toggleEditSelector)).on('click.settingstray', toggleEditMode);
    }
  };
  $(window).on({
