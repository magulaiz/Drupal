...
abstract class TipPluginBase extends PluginBase implements TipPluginInterface {
  ...
  public function __construct(array $configuration, $plugin_id, $plugin_definition) {
    ...
    if (!$this instanceof TourTipPluginInterface) {
      @trigger_error('Implementing ' . __NAMESPACE__ . '\TipPluginInterface without also implementing ' . __NAMESPACE__ . '\TourTipPluginInterface is deprecated in drupal:9.2.0 and will cause an error in drupal:10.0.0. See https://www.drupal.org/node/3204096', E_USER_DEPRECATED);
    }
  }
