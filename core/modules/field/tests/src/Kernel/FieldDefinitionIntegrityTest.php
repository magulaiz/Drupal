...
class FieldDefinitionIntegrityTest extends KernelTestBase {
   ...
   */
  protected function checkDisplayOption(string $entity_type_id, string $field_id, BaseFieldDefinition $field_definition, DiscoveryInterface $plugin_manager, string $display_context) {
   ...
   */
  protected function modulesWithSubdirectory(string $subdirectory) {
