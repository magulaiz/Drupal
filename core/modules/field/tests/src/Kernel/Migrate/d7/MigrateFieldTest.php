...
class MigrateFieldTest extends MigrateDrupal7TestBase {
  ...
  public function testDatetimeFields() {
    ...
    $msg = "d7_field:type:process_field(1): Can't migrate field 'field_event' with 'todate' settings. Enable the datetime_range module. See https://www.drupal.org/docs/8/upgrade/known-issues-when-upgrading-from-drupal-6-or-7-to-drupal-8#datetime";
