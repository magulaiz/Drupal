...
class MigrateFieldTest extends MigrateDrupal7TestBase {
  ...
  public function testDatetimeFields() {
    ...
    $msg = "d7_field:type:0:process_field: Can't migrate field 'field_event' with 'todate' settings. Enable the datetime_range module. See https://www.drupal.org/docs/8/upgrade/known-issues-when-upgrading-from-drupal-6-or-7-to-drupal-8#datetime";
