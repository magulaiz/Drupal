...
class FieldUiTestHooks
{
    ...
    public function fieldConfigAccess(\Drupal\Core\Field\FieldConfigInterface $field)
    {
        return \Drupal\Core\Access\AccessResult::forbiddenIf($field->getName() == 'highlander');
    }
    /**
