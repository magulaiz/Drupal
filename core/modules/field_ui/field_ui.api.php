 ...
 */
function hook_field_formatter_third_party_settings_form(\Drupal\Core\Field\FormatterInterface $plugin, \Drupal\Core\Field\FieldDefinitionInterface $field_definition, string $view_mode, array $form, \Drupal\Core\Form\FormStateInterface $form_state) {
  $element = [];
 ...
 */
function hook_field_widget_third_party_settings_form(\Drupal\Core\Field\WidgetInterface $plugin, \Drupal\Core\Field\FieldDefinitionInterface $field_definition, string $form_mode, array $form, \Drupal\Core\Form\FormStateInterface $form_state) {
  $element = [];
