...
class ConfigSync extends FormBase {
   ...
   *   The theme extension list.
   */
  public function __construct(protected StorageInterface $syncStorage, protected StorageInterface $activeStorage, protected StorageInterface $snapshotStorage, protected LockBackendInterface $lock, protected EventDispatcherInterface $eventDispatcher, protected ConfigManagerInterface $configManager, protected TypedConfigManagerInterface $typedConfigManager, protected ModuleHandlerInterface $moduleHandler, protected ModuleInstallerInterface $moduleInstaller, protected ThemeHandlerInterface $themeHandler, protected RendererInterface $renderer, protected ModuleExtensionList $moduleExtensionList, protected ImportStorageTransformer $importTransformer, ThemeExtensionList $extension_list_theme = NULL) {
