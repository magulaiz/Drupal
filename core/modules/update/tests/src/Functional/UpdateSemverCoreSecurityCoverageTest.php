...
class UpdateSemverCoreSecurityCoverageTest extends UpdateSemverCoreTestBase {
   ...
   */
  public function testSecurityCoverageMessage(string $installed_version, string $fixture, string $requirements_section_heading, string $message, string $mock_date) {
