...
trait UpdateSemverTestSecurityAvailabilityTrait {
   ...
   */
  public function testSecurityUpdateAvailability(string $site_patch_version, array $expected_security_releases, string $expected_update_message_type, string $fixture) {
