...
/**
 * Tests update of update.settings:notification.emails.
 *
 * @group system
 * @covers \update_post_update_empty_notification_emails_to_null
 */
class UpdateSettingsNotificationEmailsUpdateTest extends UpdatePathTestBase {
