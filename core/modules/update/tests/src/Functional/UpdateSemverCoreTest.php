  ...
  public function securityCoverageMessageProvider() {
    ...
    $test_cases = [
      '8.0.0, unsupported' => [
        ...
        'message' => "Drupal 8.0 $coverage_ended_message $update_asap_message $release_coverage_message",
        'mock_date' => '',
      ],
      '8.1.0, supported with 3rc' => [
        ...
        'message' => "Drupal 8.1 is covered until 8.3.0 Update to 8.2 or higher soon to continue receiving security updates. $release_coverage_message",
        'mock_date' => '',
      ],
      '8.1.0, supported' => [
        'installed_version' => '8.1.0',
      ...
      '8.2.0, supported with 3rc' => [
        ...
        'message' => "Drupal 8.2 is covered until 8.4.0 $release_coverage_message",
        'mock_date' => '',
      ],
      '8.2.0, supported' => [
        'installed_version' => '8.2.0',
      ...
      '8.2.0, 9 warning' => [
        ...
        'fixture' => 'sec.2.0_9.0.0',
        'requirements_section_heading' => 'Warnings found',
        'message' => "Drupal 8.2 is covered until 8.4.0 Update to 8.3 or higher soon to continue receiving security updates. $release_coverage_message",
        'mock_date' => '',
      ],
    ];
    ...
    $test_cases += [
      ...
      '8.8.0, supported' => [
        ...
        'fixture' => 'sec.9.0',
        'requirements_section_heading' => 'Checked',
        'message' => "Drupal 8.8 is covered until 2020-Dec-02 $release_coverage_message",
    ...
    $test_cases['8.8.0, support over'] = [
      ...
      'fixture' => 'sec.9.0',
      'requirements_section_heading' => 'Errors found',
      'message' => "Drupal 8.8 $coverage_ended_message $update_asap_message $release_coverage_message",
    ...
    $test_cases['8.9.0, lts supported'] = [
      ...
      'fixture' => 'sec.9.0',
      'requirements_section_heading' => 'Checked',
      'message' => "Drupal 8.9 is covered until 2021-Nov $release_coverage_message",
    ...
    $test_cases['8.9.0, lts support over'] = [
      ...
      'fixture' => 'sec.9.0',
      'requirements_section_heading' => 'Errors found',
      'message' => "Drupal 8.9 $coverage_ended_message $update_asap_message $release_coverage_message",
    ...
    $test_cases += [
      ...
      '9.9.0' => [
        ...
        'fixture' => 'sec.9.9.0',
        'requirements_section_heading' => 'Checked',
        'message' => "Drupal 9.9 is covered until 9.11.0 $release_coverage_message",
        'mock_date' => '',
      ],
      '9.8.0' => [
        ...
        'fixture' => 'sec.9.9.0',
        'requirements_section_heading' => 'Warnings found',
        'message' => "Drupal 9.8 is covered until 9.10.0 Update to 9.9 or higher soon to continue receiving security updates. $release_coverage_message",
        'mock_date' => '',
      ],
    ];
    return $test_cases;
