...
class UpdateFetcher implements UpdateFetcherInterface {
  ...
  public function __construct(ConfigFactoryInterface $config_factory, ClientInterface $http_client, Settings $settings = NULL) {
    ...
    if (is_null($settings)) {
      @trigger_error('Calling UpdateFetcher::__construct() without the settings service is deprecated in drupal:9.1.0 and it will be required in drupal:10.0.0. See https://www.drupal.org/node/3179315', E_USER_DEPRECATED);
