...
class BookExport {
  ...
  public function __construct(EntityTypeManagerInterface $entity_type_manager, BookManagerInterface $book_manager, EntityRepositoryInterface $entity_repository = NULL) {
    ...
    if (!$entity_repository) {
      @trigger_error('Calling ' . __NAMESPACE__ . '\BookExport::__construct() without the entity.repository service is deprecated in drupal:9.2.0 and will be required in drupal:10.0.0. See https://www.drupal.org/node/2470896', E_USER_DEPRECATED);
