...
/**
 * Tests the behavior of generating entity URLs when using entity links in CKE.
 *
...
class EntityLinksTest extends KernelTestBase {
   ...
   * [false, "file", {"target_id": 1}, "/<SITE_DIRECTORY>/files/druplicon.txt",
   * ["file:1", "media:1"]]
   * [true,  "oembed:video",
   ...
   * [false, "oembed:video",
   * {"value":"https://www.youtube.com/watch?v=dQw4w9WgXcQ"},
   * "https://www.youtube.com/watch?v=dQw4w9WgXcQ", ["media:1"]]
