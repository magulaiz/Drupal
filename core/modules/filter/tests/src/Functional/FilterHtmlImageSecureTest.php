...
class FilterHtmlImageSecureTest extends BrowserTestBase {
  ...
  public function testImageSource() {
    ...
    $images = [
      ...
      preg_replace($host_pattern, 'https://' . $host . ':', $http_base_url . '/' . $druplicon) => base_path() . $druplicon,
      preg_replace($host_pattern, 'https://' . $host . ':80', $http_base_url . '/' . $druplicon) => base_path() . $druplicon,
      preg_replace($host_pattern, 'https://' . $host . ':443', $http_base_url . '/' . $druplicon) => base_path() . $druplicon,
      preg_replace($host_pattern, 'https://' . $host . ':8080', $http_base_url . '/' . $druplicon) => base_path() . $druplicon,
