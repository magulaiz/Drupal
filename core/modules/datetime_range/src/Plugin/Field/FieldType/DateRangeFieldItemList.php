...
class DateRangeFieldItemList extends DateTimeFieldItemList {
  ...
  public static function processDefaultValue($default_value, FieldableEntityInterface $entity, FieldDefinitionInterface $definition) {
    ...
    if (!empty($default_value[0]['default_date_type']) || !empty($default_value[0]['default_end_date_type'])) {
      ...
      // value fields.
      $storage_format = $definition->getSetting('datetime_type') == DateTimeItemInterface::DATETIME_TYPE_DATE ? DateTimeItemInterface::DATE_STORAGE_FORMAT : DateTimeItemInterface::DATETIME_STORAGE_FORMAT;
      $default_values = [[]];
