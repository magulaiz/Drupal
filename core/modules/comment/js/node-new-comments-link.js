    ...
    function render(results) {
      Object.keys(results || {}).forEach(function (nodeID) {
        if ($placeholdersToUpdate.hasOwnProperty(nodeID)) {
          $placeholdersToUpdate[nodeID][0].textContent = Drupal.formatPlural(results[nodeID].new_comment_count, '1 new comment', '@count new comments');
          $placeholdersToUpdate[nodeID].attr('href', results[nodeID].first_new_comment_link).removeClass('hidden');
