...
class CommentHooks {
      ...
      case 'user_cancel_reassign_user':
        ...
        foreach ($comments as $comment) {
          ...
          foreach ($langcodes as $langcode) {
            ...
            $comment_translated->setOwnerId($uid);
            $comment_translated->setAuthorName($user_name);
          }
          $comment->save();
        }
        break;
  ...
  public function entityViewDisplayPresave(EntityViewDisplayInterface $display) {
    ...
    // Disable the comment field formatter when the used view display
    // is disabled.
