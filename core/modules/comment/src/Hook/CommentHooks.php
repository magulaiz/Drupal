...
class CommentHooks {
  ...
  public function formFieldUiFieldStorageAddFormAlter(&$form, FormStateInterface $form_state) {
  ...
  public function formFieldUiFormDisplayOverviewFormAlter(&$form, FormStateInterface $form_state) {
    $route_match = \Drupal::routeMatch();
  ...
  public function formFieldUiDisplayOverviewFormAlter(&$form, FormStateInterface $form_state) {
    $route_match = \Drupal::routeMatch();
    if ($form['#entity_type'] == 'comment' && $route_match->getParameter('commented_entity_type')) {
      $form['#title'] = \Drupal::service('comment.manager')->getFieldUIPageTitle($route_match->getParameter('commented_entity_type'), $route_match->getParameter('field_name'));
    }
