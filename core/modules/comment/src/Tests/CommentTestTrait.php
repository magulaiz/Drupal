...
trait CommentTestTrait {
   ...
   *   Defaults to 'full'.
   */
  public function addDefaultCommentField(string $entity_type, string $bundle, string $field_name = 'comment', $default_value = CommentItemInterface::OPEN, string $comment_type_id = 'comment', string $comment_view_mode = 'full') {
