...
class CommentEntityTranslation extends FieldableEntity {
  ...
  public function query() {
    ...
    $query->innerJoin('comment', 'c', $this->getDatabase()->condition('AND')->compare('c.cid', 'et.entity_id'));
    $query->innerJoin('node', 'n', $this->getDatabase()->condition('AND')->compare('n.nid', 'c.nid'));
