 ...
 */
#[\Drupal\Core\Entity\Attribute\ContentEntityType(id: 'comment_test_base_field', label: new TranslatableMarkup('Test comment - base field'), base_table: 'comment_test_base_field', entity_keys: ['id' => 'id', 'uuid' => 'uuid', 'bundle' => 'type'])]
