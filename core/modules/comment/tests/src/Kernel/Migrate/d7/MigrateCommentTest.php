...
class MigrateCommentTest extends MigrateDrupal7TestBase {
  ...
  public function testMigration(): void {
    ...
    $this->assertSame('This is a comment', $comment->get('comment_body')->value);
    ...
    $this->assertSame('1000000', $comment->get('field_integer')->value);
    ...
    $this->assertSame('TNG is better than DS9.', $comment->get('comment_body')->value);
    $this->assertSame('en', $comment->language()->getId());
    ...
    $this->assertSame('This is a comment to an Icelandic translation.', $comment->get('comment_body')->value);
    ...
    $this->assertSame('A comment without language (migrated from Drupal 6)', $comment->get('comment_body')->value);
    $this->assertSame('filtered_html', $comment->get('comment_body')->format);
    $this->assertSame('drupal7.local', $comment->getHostname());
    $this->assertSame('und', $comment->language()->getId());
    $this->assertSame('10', $comment->get('field_integer')->value);
    ...
    $this->assertSame('1000000', $comment->get('field_integer')->value);
    $this->assertSame('2000000', $comment_fr->get('field_integer')->value);
    $this->assertSame('3000000', $comment_is->get('field_integer')->value);
    ...
    $this->assertSame('1', $metadata_fr->getAuthor()->id());
    ...
    $this->assertSame('2', $metadata_is->getAuthor()->id());
