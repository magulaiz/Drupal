...
class MenuLinkTranslation extends MigrateDrupalD7MenuLinkTranslation {
  ...
  public function __construct(array $configuration, $plugin_id, $plugin_definition, MigrationInterface $migration, StateInterface $state, EntityTypeManagerInterface $entity_type_manager) {
    @trigger_error('\Drupal\menu_link_content\Plugin\migrate\source\d7\MenuLinkTranslation is deprecated in drupal:10.3.0 and is removed from drupal:12.0.0. Use \Drupal\migrate_drupal\Plugin\migrate\source\d7\MenuLinkTranslation instead. See https://www.drupal.org/node/3439256', E_USER_DEPRECATED);
