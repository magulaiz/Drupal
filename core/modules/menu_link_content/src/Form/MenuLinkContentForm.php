...
class MenuLinkContentForm extends ContentEntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    if ($this->entity->isNew()) {
      $form['menu_parent_fieldset']['menu_parent_wrapper']['menu_parent'] = $this->menuParentSelector->parentSelectElement($default, $id, [
        $menu_id => $menu->label(),
      ]);
      $form['menu_parent_fieldset']['menu_parent_wrapper']['#type'] = 'container';
    }
    else {
