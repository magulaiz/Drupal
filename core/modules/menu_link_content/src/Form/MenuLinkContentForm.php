...
class MenuLinkContentForm extends ContentEntityForm {
   ...
   *   The time service.
   */
  public function __construct(EntityRepositoryInterface $entity_repository, protected MenuParentFormSelectorInterface $menuParentSelector, LanguageManagerInterface $language_manager, protected PathValidatorInterface $pathValidator, EntityTypeBundleInfoInterface $entity_type_bundle_info = NULL, TimeInterface $time = NULL) {
