...
class MediaHooks {
  ...
  public function formFieldUiFieldStorageAddFormAlter(&$form, FormStateInterface $form_state, $form_id) {
  ...
  public function formFilterFormatEditFormAlter(array &$form, FormStateInterface $form_state, $form_id) {
  ...
  public function formFilterFormatAddFormAlter(array &$form, FormStateInterface $form_state, $form_id) {
    // Add an additional validate callback so we can ensure the order of filters
    // is correct.
    $form['#validate'][] = 'media_filter_format_edit_form_validate';
  }
