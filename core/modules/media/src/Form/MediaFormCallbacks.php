...
/**
 * Implements trusted form callbacks for media module.
 */
class MediaFormCallbacks {

  /**
   * Implements #validate callback for filter edit form & filter add form.
   *
   * Ensures filter order and allowed_html are compatible.
   */
  #[TrustedCallback]
  public static function filterFormatEditFormValidate(array $form, FormStateInterface $form_state):void {
