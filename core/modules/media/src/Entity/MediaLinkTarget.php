...
class MediaLinkTarget implements EntityLinkTargetInterface {
  ...
  public function getLinkTarget(EntityInterface $entity): GeneratedUrl {
    ...
    // Below is an example of how to get the generated URL object
    // for a media linked entity which is used in Entity links filter.
    // @see \Drupal\filter\Plugin\Filter\EntityLinks::getUrl().
    // At this point, media entity type is not enabled for entity
    // suggestions in CKEditor.
    // @see ckeditor5_entity_bundle_info_alter() in ckeditor5.module.
    // Technically, media link target handler should not be in the core
    // until core supports media entity by default,
