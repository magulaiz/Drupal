...
class Media extends EditorialContentEntityBase implements MediaInterface {
  ...
  public static function getRequestTime() {
    @trigger_error(__METHOD__ . ' is deprecated in drupal:10.1.0 and is removed from drupal:11.0.0. No replacement provided. See https://www.drupal.org/node/3349765', E_USER_DEPRECATED);
