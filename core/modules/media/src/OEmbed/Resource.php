...
class Resource implements CacheableDependencyInterface {
   ...
   */
  protected function __construct(Provider $provider = NULL, string $title = NULL, string $author_name = NULL, string $author_url = NULL, $cache_age = NULL, string $thumbnail_url = NULL, $thumbnail_width = NULL, $thumbnail_height = NULL) {
   ...
   * @return static
   */
  public static function link(string $url = NULL, Provider $provider = NULL, string $title = NULL, string $author_name = NULL, string $author_url = NULL, $cache_age = NULL, string $thumbnail_url = NULL, $thumbnail_width = NULL, $thumbnail_height = NULL) {
   ...
   * @return static
   */
  public static function photo(string $url, $width, $height = NULL, Provider $provider = NULL, string $title = NULL, string $author_name = NULL, string $author_url = NULL, $cache_age = NULL, string $thumbnail_url = NULL, $thumbnail_width = NULL, $thumbnail_height = NULL) {
    if (empty($url)) {
   ...
   * @return static
   */
  public static function rich(string $html, $width, $height = NULL, Provider $provider = NULL, string $title = NULL, string $author_name = NULL, string $author_url = NULL, $cache_age = NULL, string $thumbnail_url = NULL, $thumbnail_width = NULL, $thumbnail_height = NULL) {
    if (empty($html)) {
   ...
   * @return static
   */
  public static function video(string $html, $width, $height = NULL, Provider $provider = NULL, string $title = NULL, string $author_name = NULL, string $author_url = NULL, $cache_age = NULL, string $thumbnail_url = NULL, $thumbnail_width = NULL, $thumbnail_height = NULL) {
