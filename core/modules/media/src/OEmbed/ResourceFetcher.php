...
class ResourceFetcher implements ResourceFetcherInterface {
   ...
   *
   * @deprecated in drupal:9.4.0 and is removed from drupal:10.0.0. Call
   *   decode() on the injected
   *   Symfony\Component\Serializer\Encoder\DecoderInterface object instead.
   *
   * @see https://www.drupal.org/node/3271751
   */
  protected function parseResourceXml($data, $url) {
    @trigger_error(__METHOD__ . '() is deprecated in drupal:9.4.0 and is removed from drupal:10.0.0. Call Symfony\Component\Serializer\Encoder\DecoderInterface::decode() instead. See https://www.drupal.org/node/3271751', E_USER_DEPRECATED);
