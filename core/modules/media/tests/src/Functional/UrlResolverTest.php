  ...
  public function providerEndpointMatching() {
    return [
      ...
      'match by endpoint: CollegeHumor' => [
        'https://www.collegehumor.com/video/40002870/lets-not-get-a-drink-sometime',
        'https://www.collegehumor.com/oembed.json?url=https://www.collegehumor.com/video/40002870/lets-not-get-a-drink-sometime',
      ],
  ...
  public function providerUrlDiscovery() {
    return [
      ...
      'XML resource' => [
        ...
        'https://www.collegehumor.com/oembed.json?url=video_collegehumor.html',
      ],
    ];
  }
