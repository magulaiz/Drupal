...
/**
 * @covers \Drupal\media\Plugin\Field\FieldFormatter\MediaResponsiveThumbnailFormatter
 *
 * @group media
 */
class MediaResponsiveThumbnailFormatterTest extends MediaFunctionalTestBase {
  ...
  /**
   * Tests the media responsive thumbnail field formatter.
   */
  public function testRender(): void {
    ...
    // Change the image responsive thumbnail to point to the media.
    ...
    // Change the image responsive thumbnail to point to the node.
  ...
  private function changeMediaReferenceFieldLinkType(string $type): void {
    // Change the display to use the media responsive thumbnail
    // formatter with image link.
    $this->container->get('entity_display.repository')
