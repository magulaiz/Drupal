...
/**
 * @coversDefaultClass \Drupal\media\Plugin\Field\FieldFormatter\MediaResponsiveThumbnailFormatter
 * @group media
 */
class MediaResponsiveThumbnailFormatterTest extends MediaKernelTestBase {
