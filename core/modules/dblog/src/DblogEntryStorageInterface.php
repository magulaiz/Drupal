...
interface DblogEntryStorageInterface extends ContentEntityStorageInterface {
   ...
   *
   * @return array
   *   An array of more frequent event occurrences. Each occurrence is a pair of
   *   'count' and 'entry' where count is number of times the event was logged
   *   and 'entry' an instance of Drupal\dblog\Entity\DblogEntryInterface.
   *   Occurrences should be sorted by count in descending order.
   */
