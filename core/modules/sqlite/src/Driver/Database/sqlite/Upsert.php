...
class Upsert extends QueryUpsert {
  ...
  public function __toString() {
    ...
    $query = $comments . 'INSERT INTO {' . $this->table . '} (' . implode(', ', $insert_fields) . ') ';
    ...
    if ($this->useSinglePlaceholder) {
      ...
      // The extra 'WHERE TRUE' is needed to remove a parsing ambiguity.
      $query .= $json_select_query . 'WHERE TRUE';
    }
    else {
