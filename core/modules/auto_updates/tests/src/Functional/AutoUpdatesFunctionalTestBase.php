...
abstract class AutoUpdatesFunctionalTestBase extends BrowserTestBase {
  ...
  protected $disableValidators = [
    ...
    // @todo https://www.drupal.org/project/auto_updates/issues/3320755.
  ...
  protected function tearDown(): void {
    ...
    $service_ids = [
      // If auto_updates is installed, ensure any stage directory created
   ...
   * auto_updates_test_disable_validators module is installed.
   *
   * @param string[] $validators
   *   The service IDs of the validators to disable.
   *
   * @see \Drupal\auto_updates_test_disable_validators\AutoUpdatesTestDisableValidatorsServiceProvider::alter()
   */
  protected function disableValidators(array $validators): void {
    $key = 'auto_updates_test_disable_validators';
