 ...
 * @internal
 */
class StatusCheckTest extends AutoUpdatesFunctionalTestBase {
  ...
  public function testModuleFormInstallDisplay(int $results_severity): void {
    ...
    $this->container->get('module_installer')->uninstall(['auto_updates']);
   ...
   *
   * @see \Drupal\auto_updates\Routing\RouteSubscriber::alterRoutes()
   *
   * @return string[][]
   *   The test cases.
   */
  ...
  public function testStatusCheckUninstall(): void {
    ...
    $this->container->get('module_installer')->install([
      'auto_updates',
      'auto_updates_test',
      'auto_updates_test_status_checker',
    ]);
  ...
  public function testStatusReportShowsCachedResults(): void {
    ...
    // @see \Drupal\auto_updates\Validation\StatusChecker::onConfigSave()
    $this->config('auto_updates.settings')
