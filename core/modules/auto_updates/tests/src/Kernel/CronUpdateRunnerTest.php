...
/**
 * @coversDefaultClass  \Drupal\auto_updates\CronUpdateRunner
 * @group auto_updates
 * @internal
 */
class CronUpdateRunnerTest extends AutoUpdatesKernelTestBase {
  ...
  public function testHookCronInvoked(): void {
    ...
    // @see \Drupal\Tests\auto_updates\Kernel\AutoUpdatesKernelTestBase::setUp
    ...
    // if that happened.
    // @see \Drupal\Tests\auto_updates\Kernel\TestCronUpdateRunner::runTerminalUpdateCommand
  ...
  private function assertCronRan(): void {
    $this->assertTrue(
      ...
      '\Drupal\Tests\auto_updates\Kernel\AutoUpdatesKernelTestBase::assertCronRan can only be used if common_test_cron_helper is enabled.'
    );
