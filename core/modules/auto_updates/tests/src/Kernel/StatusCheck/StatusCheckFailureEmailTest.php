 ...
 *
 * @group auto_updates
 * @covers \Drupal\auto_updates\StatusCheckMailer
 * @internal
 */
class StatusCheckFailureEmailTest extends AutoUpdatesKernelTestBase {
  ...
  private function assertSentMessagesCount(int $expected_count): void {
    $sent_messages = $this->getMails([
      'id' => 'auto_updates_status_check_failed',
    ]);
