...
class VersionPolicyValidatorTest extends AutoUpdatesKernelTestBase {
   ...
   *   \Drupal\auto_updates\CronUpdateRunner::DISABLED,
   *   \Drupal\auto_updates\CronUpdateRunner::SECURITY, and
   *   \Drupal\auto_updates\CronUpdateRunner::ALL.
  ...
  public function testCronPreCreate(string $installed_version, string $target_version, string $release_metadata, array $cron_modes, array $expected_validation_messages, bool $allow_minor_updates = FALSE): void {
    ...
    // @see \Drupal\auto_updates\Validator\VersionPolicyValidator::validateVersion()
  ...
  public function testNoCorePackagesInstalled(): void {
    $listener = function (PreCreateEvent $event): void {
      ...
      /** @var \Drupal\auto_updates\UpdateStage $stage */
      $stage = $event->stage;
