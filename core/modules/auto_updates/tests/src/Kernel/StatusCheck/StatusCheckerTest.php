...
class StatusCheckerTest extends AutoUpdatesKernelTestBase {
  ...
  public function testGetResults(): void {
    $this->container->get('module_installer')
      ->install(['auto_updates', 'auto_updates_test2']);
  ...
  public function testRunIfNeeded(): void {
    ...
    $manager = $this->container->get('auto_updates.status_checker');
  ...
  public function testCronSetting(): void {
    ...
    $this->container->get('auto_updates.status_checker')->run();
  ...
  public function testStoredResultsDeletedPostApply(): void {
    ...
    /** @var \Drupal\auto_updates\Validation\StatusChecker $manager */
    $manager = $this->container->get('auto_updates.status_checker')
      ->run();
