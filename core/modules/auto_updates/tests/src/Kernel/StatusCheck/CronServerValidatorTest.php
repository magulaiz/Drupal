...
use Drupal\auto_updates\Validator\CronServerValidator;
...
/**
 * @covers \Drupal\auto_updates\Validator\CronServerValidator
 * @group auto_updates
 * @internal
 */
class CronServerValidatorTest extends AutoUpdatesKernelTestBase {
   ...
   *   \Drupal\auto_updates\CronUpdater::SECURITY, or
  ...
  public function testHelpLink(bool $alternate_port, string $server_api, string $cron_mode, array $expected_results): void {
    ...
    $url = Url::fromRoute('help.page')
      ->setRouteParameter('name', 'auto_updates')
