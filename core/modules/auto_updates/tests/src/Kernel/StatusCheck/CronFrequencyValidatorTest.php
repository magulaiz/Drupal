...
use Drupal\Tests\auto_updates\Kernel\TestCronUpdateRunner;
...
class CronFrequencyValidatorTest extends AutoUpdatesKernelTestBase {
  ...
  public function testLastCronRunValidation(int $last_run, array $expected_results): void {
    ...
    try {
      ...
      // @see \Drupal\Tests\auto_updates\Kernel\AutoUpdatesKernelTestBase::runUpdateViaConsole
      ...
      // @see \Drupal\auto_updates\CronUpdateRunner::run
      $this->assertCheckerResultsFromManager([], TRUE);
    }
  }
