...
class ReadinessCheckEvent extends PreOperationStageEvent {
  ...
  public function __construct(Stage $stage, array $project_versions = []) {
    @trigger_error(__CLASS__ . ' is deprecated in auto_updates:8.x-2.5 and will be removed in auto_updates:3.0.0. Use \Drupal\package_manager\Event\StatusCheckEvent instead. See https://www.drupal.org/node/3316086.', E_USER_DEPRECATED);
