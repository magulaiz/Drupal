...
final class ReadinessValidationManager {
  ...
  /**
   * Wraps \Drupal\auto_updates\Validation\StatusChecker::run().
   */
  ...
  /**
   * Wraps \Drupal\auto_updates\Validation\StatusChecker::runIfNoStoredResults().
   */
  ...
  /**
   * Wraps \Drupal\auto_updates\Validation\StatusChecker::getResults().
   */
  ...
  /**
   * Wraps \Drupal\auto_updates\Validation\StatusChecker::clearStoredResults().
   */
  ...
  /**
   * Wraps \Drupal\auto_updates\Validation\StatusChecker::getLastRunTime().
   */
  ...
  /**
   * Wraps \Drupal\auto_updates\Validation\StatusChecker::getSubscribedEvents().
   */
