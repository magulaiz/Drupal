...
final class StatusChecker implements EventSubscriberInterface {
   ...
   * @param \Drupal\auto_updates\UpdateStage $updateStage
   *   The update stage service.
   * @param \Drupal\auto_updates\ConsoleUpdateStage $consoleUpdateStage
  ...
  public function onConfigSave(ConfigCrudEvent $event): void {
    ...
    elseif ($config->getName() === 'auto_updates.settings') {
