...
final class BatchProcessor {
   ...
   * @var string
   */
  private const ERROR_MESSAGES_SESSION_KEY = '_auto_updates_errors';

  /**
   * Gets the update stage service.
   *
   * @return \Drupal\auto_updates\UpdateStage
   ...
   *
   * @see \Drupal\auto_updates\UpdateStage::begin()
   */
   ...
   *
   * @see \Drupal\auto_updates\UpdateStage::stage()
   */
   ...
   *   The stage ID.
   *
   * @see \Drupal\auto_updates\UpdateStage::apply()
   */
   ...
   *   The stage ID.
   *
   * @see \Drupal\auto_updates\UpdateStage::postApply()
   */
   ...
   *
   * @see \Drupal\auto_updates\UpdateStage::destroy()
   */
