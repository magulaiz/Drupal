...
class ConsoleUpdateStage extends UpdateStage {
   ...
   * @var string
   */
  protected const VERSIONS_METADATA_KEY = 'auto_updates_versions';
   ...
   *   The lock service.
   * @param \Drupal\auto_updates\CronUpdateRunner $cronUpdateRunner
   *   The cron update runner service.
   * @param \Drupal\Core\Mail\MailManagerInterface $mailManager
   *   The mail manager service.
   * @param \Drupal\auto_updates\StatusCheckMailer $statusCheckMailer
   *   The status check mailer service.
   * @param \Drupal\auto_updates\ReleaseChooser $releaseChooser
   *   The cron release chooser service.
   * @param \Drupal\auto_updates\CommandExecutor $commandExecutor
  ...
  final public function begin(array $project_versions, ?int $timeout = 300): never {
    ...
    // version of core, use \Drupal\auto_updates\UpdateStage::begin()
