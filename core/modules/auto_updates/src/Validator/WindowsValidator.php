...
final class WindowsValidator implements EventSubscriberInterface {
   ...
   *
   * @param \Drupal\auto_updates\CronUpdateRunner $cronRunner
  ...
  public function validate(PreOperationStageEvent $event): void {
    ...
    $stage = $event->stage;
    if ($stage->getType() === 'auto_updates:unattended' && $this->cronRunner->getMode() !== CronUpdateRunner::DISABLED && $method === 'web') {
