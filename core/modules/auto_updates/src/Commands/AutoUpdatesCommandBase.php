 ...
 *   class.
 */
abstract class AutoUpdatesCommandBase extends Command {
   ...
   *
   * @var \Drupal\auto_updates\ConsoleUpdateStage
   */
  protected ConsoleUpdateStage $stage;

  /**
   * Constructs an AutoUpdatesCommandBase object.
   *
