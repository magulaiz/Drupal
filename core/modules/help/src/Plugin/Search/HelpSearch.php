...
class HelpSearch extends SearchPluginBase implements AccessibleInterface, SearchIndexingInterface {
  ...
  protected function findResults() {
    ...
    $query->innerJoin('help_search_items', 'hsi', $this->database->condition('AND')->compare('i.sid', 'hsi.sid')->condition('i.type', $this->getType()));
  ...
  public function updateIndex() {
    ...
    $query->leftJoin('search_dataset', 'sd', $this->database->condition('AND')->compare('sd.sid', 'hsi.sid')->condition('sd.type', $this->getType()));
  ...
  public function updateIndexState() {
    ...
    $query->leftJoin('search_dataset', 'sd', $this->database->condition('AND')->compare('hsi.sid', 'sd.sid')->condition('sd.type', $this->getType()));
    $query->isNull('sd.sid');
