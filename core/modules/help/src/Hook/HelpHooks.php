    ...
    switch ($route_name) {
      case 'help.main':
        ...
        if (\Drupal::moduleHandler()->moduleExists('node')) {
          $output .= '<li>' . t('<strong>Start posting content</strong> Finally, you may <a href=":content">add new content</a> to your website.', [':content' => Url::fromRoute('entity.node.add_page')->toString()]) . '</li>';
        }
        $output .= '</ol>';
