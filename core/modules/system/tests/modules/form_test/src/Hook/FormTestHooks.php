...
class FormTestHooks
{
    ...
    public function blockFormFormTestAlterFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
    ...
    public function formFormTestAlterFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
    ...
    public function systemFormFormTestAlterFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
    ...
    public function formUserRegisterFormAlter(&$form, \Drupal\Core\Form\FormStateInterface $form_state)
    {
        $form['test_rebuild'] = ['#type' => 'submit', '#value' => \t('Rebuild'), '#submit' => ['form_test_user_register_form_rebuild']];
    }
    /**
    ...
    public function formFormTestVerticalTabsAccessFormAlter(&$form, &$form_state, $form_id)
    {
