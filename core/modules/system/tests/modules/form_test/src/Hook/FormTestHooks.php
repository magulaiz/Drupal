...
class FormTestHooks {
  ...
  public function blockFormFormTestAlterFormAlter(&$form, FormStateInterface $form_state) {
  ...
  public function formFormTestAlterFormAlter(&$form, FormStateInterface $form_state) {
  ...
  public function systemFormFormTestAlterFormAlter(&$form, FormStateInterface $form_state) {
  ...
  public function formUserRegisterFormAlter(&$form, FormStateInterface $form_state) {
