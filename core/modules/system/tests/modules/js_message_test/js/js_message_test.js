...
(function ($, _ref, _ref2) {
  ...
  behaviors.js_message_test = {
    attach: function attach() {
      $(Drupal.once('messages-details', '[data-drupal-messages-area]')).on('click', '[data-action]', function (e) {
      ...
      $(Drupal.once('add-multiple', '[data-action="add-multiple"]')).on('click', function () {
      ...
      $(Drupal.once('remove-multiple', '[data-action="remove-multiple"]')).on('click', function () {
      ...
      $(Drupal.once('add-multiple-error', '[data-action="add-multiple-error"]')).on('click', function () {
        [0, 1, 2, 3, 4, 5].forEach(function (i) {
      ...
      $(Drupal.once('remove-type', '[data-action="remove-type"]')).on('click', function () {
      ...
      $(Drupal.once('clear-all', '[data-action="clear-all"]')).on('click', function () {
        messageObjects.default.zone.clear();
      });
      $(Drupal.once('id-no-status', '[data-action="id-no-status"]')).on('click', function () {
