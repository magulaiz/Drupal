...
class ThemeTestThemeSuggestionHook {
  ...
  public function themeSuggestionsThemeTestPreprocessSuggestions($variables) {
  ...
  public function themeSuggestionsThemeTestSuggestionProvided(array $variables) {
  ...
  public function themeSuggestionsNode(array $variables) {
