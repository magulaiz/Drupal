...
class TwigThemeTestHooks {
  ...
  public function theme($existing, $type, $theme, $path) {
    ...
    $items['twig_theme_test_placeholder_outside_trans'] = ['variables' => ['var' => ''], 'template' => 'twig_theme_test.placeholder_outside_trans'];
    ...
    $items['twig_theme_test_link_generator'] = ['variables' => ['test_url' => \NULL, 'test_url_attribute' => \NULL, 'attributes' => []], 'template' => 'twig_theme_test.link_generator'];
    $items['twig_theme_test_url_to_string'] = ['variables' => ['test_url' => \NULL], 'template' => 'twig_theme_test.url_to_string'];
    ...
    $items['twig_theme_test_renderable'] = ['variables' => ['renderable' => \NULL], 'template' => 'twig_theme_test.renderable'];
