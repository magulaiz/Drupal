...
class SplitButtonTestForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $disabled = FALSE) {
    ...
    // The Danger button has different styling so it gets its own item here.
    ...
    $form['single_items']['other_elements'] = [
      '#type' => 'splitbutton',
      '#attributes' => [
        'data-splitbutton-test-id' => 'splitbutton-other-elements',
      ],
      '#splitbutton_additional_allowed_elements' => ['checkbox', 'number', 'html_tag'],
      '#splitbutton_items' => [
        'link_three' => [
          '#type' => 'link',
          '#title' => $this->t('Inside are other elements'),
          '#url' => Url::fromRoute('splitbutton.test_link_3'),
        ],
        'link_four' => [
          '#type' => 'link',
        ...
        'added_checkbox' => [
          '#type' => 'checkbox',
          '#title' => $this->t('Some Checkbox Option'),
        ],
      ],
    ];
