...
class AdvisoryFeedTestHooks
{
    ...
    public function systemInfoAlter(&$info, \Drupal\Core\Extension\Extension $file)
    {
        ...
        $system_info = ['generic_module1_test' => ['project' => 'generic_module1_project', 'version' => '8.x-1.1', 'hidden' => \FALSE], 'generic_module2_test' => ['project' => 'generic_module2_project', 'version' => '8.x-1.1', 'hidden' => \FALSE]];
