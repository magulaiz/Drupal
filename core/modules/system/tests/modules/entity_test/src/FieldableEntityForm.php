...
/**
 * Entity form variant for fieldable entity types.
 */
class FieldableEntityForm extends EntityForm implements EntityFormInterface {
  ...
  /**
   * Constructs a FieldableEntityForm object.
   *
