 ...
 */
#[\Drupal\Core\Entity\Attribute\ContentEntityType(id: 'entity_test_default_value', label: new TranslatableMarkup('Test entity for default values'), base_table: 'entity_test_default_value', entity_keys: ['id' => 'id', 'uuid' => 'uuid', 'bundle' => 'type', 'langcode' => 'langcode'])]
