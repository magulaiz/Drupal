...
/**
 * Provides the default form handler for the Entity UI Test Type entity.
 */
class EntityUITestTypeForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => ['Drupal\entity_test\Entity\EntityUiTestType', 'load'],
        'source' => ['label'],
      ],
