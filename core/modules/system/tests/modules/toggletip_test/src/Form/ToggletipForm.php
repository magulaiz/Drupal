  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    return [
      ...
      'a_long_div_custom_positioning_right' => [
        '#type' => 'container',
        '#markup' => '<p>Long, positioned right. A container render array with longer content. You have meddled with the primal forces of nature, Mr. Beale, and I won\'t have it! Is that clear? You think you\'ve merely stopped a business deal. That is not the case! They get out their linear programming charts, statistical decision theories, minimax solutions, and compute the price-cost probabilities of their transactions and investments, just like we do. We no longer live in a world of nations and ideologies, Mr. Beale. The world is a college of corporations, inexorably determined by the immutable by-laws of business. The world is a business, Mr. Beale. It has been since man crawled out of the slime. And our children will live, Mr. Beale, to see that perfect world in which there\'s no war or famine, oppression or brutality. One vast and ecumenical holding company, for whom all men will work to serve a common profit, in which all men will hold a share of stock. All necessities provided, all anxieties tranquilized, all boredom amused. And I have chosen you, Mr. Beale, to preach this.</p>',
        '#toggletip' => [
      ...
      'a_trigger' => [
        '#type' => 'container',
        '#allowed_tags' => ['button'],
        '#markup' => '<button data-drupal-tip-toggle-button="Tooltip Text" type="button" popoverTarget="very_unique_id">This is tooltip trigger(can be any trigger)</button>',
      ],
      ...
      'a_trigger_with_placement_right_end' => [
        '#type' => 'container',
        '#allowed_tags' => ['button'],
        '#markup' => '<button data-drupal-tip-toggle-button="Tooltip Text" data-drupal-tip-placement="right-end" type="button" popoverTarget="very_very_very_unique_id">And this places tooltip on right-end</button>',
      ],
      'a_trigger_with_hover' => [
        '#type' => 'container',
        '#allowed_tags' => ['button'],
        '#markup' => '<button data-drupal-tip-toggle-button="Tooltip Text" data-drupal-tip-on-hover="true" type="button" popoverTarget="very_very_very_very_unique_id">And this one also works on hover</button>',
      ],
    ];
  }
