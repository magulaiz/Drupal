  ...
  public function help($route_name): string {
    ...
    switch ($route_name) {
      case 'help.page.experimental_module_requirements_test':
        ...
        $output = '<p>' . $this->t('The Experimental Requirements Test module is not done yet. It may eat your data, but you can read the <a href=":url">online documentation for the Experimental Requirements Test module</a>.', [':url' => 'http://www.example.com']) . '</p>';
    }
