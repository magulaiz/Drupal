...
/**
 * @file
 * Provides database changes for testing the Y2038SchemaUpdateTest upgrade path.
 *
 * @see \Drupal\Tests\system\Functional\Update\Y2038SchemaUpdateTest
 */
...
// Add a new timestamp field 'field_foo' without a database table.
