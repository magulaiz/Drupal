...
class EntityControllerLegacyTest extends KernelTestBase {
  ...
  public function testOptionalParameterDeprecation(): void {
    ...
    $this->expectDeprecation('Calling Drupal\Core\Entity\Controller\EntityController::__construct() without the $route_match argument is deprecated in drupal:10.1.0 and it will be required in drupal:11.0.0. See https://www.drupal.org/node/3337782');
