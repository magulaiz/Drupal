...
class UpdatePathNewDependencyTest extends BrowserTestBase {
  ...
  public function testUpdateNewDependency() {
    ...
    try {
      ...
      $this->assertStringContainsString('The service "new_dependency_test.dependent" has a dependency on a nonexistent service "new_dependency_test_with_service.service".', $exception->getMessage());
    }
