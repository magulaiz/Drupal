...
class EmailTest extends BrowserTestBase {
  ...
  public function testFormEmail() {
    ...
    $this->assertSession()->pageTextContains('The email addresses invalid-first, invalid-second are not valid. Use the format user@example.com.');
    ...
    $this->assertSession()->pageTextContains('The email address invalid-multiple is not valid. Use the format user@example.com.');
