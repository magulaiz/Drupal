...
class FileSystemForm extends ConfigFormBase {
   ...
   *   The file system.
   */
  public function __construct(ConfigFactoryInterface $config_factory, protected DateFormatterInterface $dateFormatter, protected StreamWrapperManagerInterface $streamWrapperManager, protected FileSystemInterface $fileSystem) {
