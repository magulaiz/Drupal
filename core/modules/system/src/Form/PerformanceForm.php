...
class PerformanceForm extends ConfigFormBase {
   ...
   *   The module handler.
   */
  public function __construct(ConfigFactoryInterface $config_factory, protected DateFormatterInterface $dateFormatter, protected AssetCollectionOptimizerInterface $cssCollectionOptimizer, protected AssetCollectionOptimizerInterface $jsCollectionOptimizer, protected ModuleHandlerInterface $moduleHandler) {
