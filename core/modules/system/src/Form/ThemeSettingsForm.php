...
class ThemeSettingsForm extends ConfigFormBase {
   ...
   *   The file system.
   */
  public function __construct(ConfigFactoryInterface $config_factory, protected ModuleHandlerInterface $moduleHandler, protected ThemeHandlerInterface $themeHandler, protected $mimeTypeGuesser, protected ThemeManagerInterface $themeManager, protected FileSystemInterface $fileSystem) {
