...
class SiteInformationForm extends ConfigFormBase {
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if (!$form_state->isValueEmpty('site_403')) {
      $form_state->setValueForElement($form['error_page']['site_403'], $form_state->getValue('site_403'));
    }
    if (!$form_state->isValueEmpty('site_404')) {
      $form_state->setValueForElement($form['error_page']['site_404'], $form_state->getValue('site_404'));
    }
