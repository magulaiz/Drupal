...
@trigger_error('ThemeExperimentalConfirmForm is deprecated in drupal 9.4.0 and is removed from drupal 10.0.0. Use \Drupal\system\Form\ExtensionConfirmForm instead. As internal API, ThemeExperimentalConfirmForm may also be removed in a minor release. See https://www.drupal.org/node/3188194', E_USER_DEPRECATED);
