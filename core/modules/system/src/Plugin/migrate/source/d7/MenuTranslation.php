...
class MenuTranslation extends Menu {
  ...
  public function query() {
    ...
    $query->leftJoin('i18n_string', 'i18n', $this->getDatabase()->condition('AND')->compare('i18n.objectid', 'm.menu_name'));
    $query->leftJoin('locales_target', 'lt', $this->getDatabase()->condition('AND')->compare('lt.lid', 'i18n.lid'));
