...
class SystemHooks {
  ...
  function themeSuggestionsPage(array $variables): array {
    $path_args = explode('/', trim(\Drupal::service('path.current')->getPath(), '/'));
  ...
  function themeSuggestionsMaintenancePage(array $variables): array {
    $suggestions = [];
  ...
  function themeSuggestionsRegion(array $variables): array {
    $suggestions = [];
  ...
  function themeSuggestionsField(array $variables): array {
    $suggestions = [];
