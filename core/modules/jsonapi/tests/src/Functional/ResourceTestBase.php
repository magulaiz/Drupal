...
abstract class ResourceTestBase extends BrowserTestBase {
   ...
   *   (MISS, HIT, UNCACHEABLE...), or TRUE when the value should be
   *   autogenerated from expected cache contexts, or FALSE if that header
   *   should be absent. Defaults to FALSE.
   */
