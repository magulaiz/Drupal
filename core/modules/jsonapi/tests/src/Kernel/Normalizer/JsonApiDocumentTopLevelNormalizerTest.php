...
class JsonApiDocumentTopLevelNormalizerTest extends JsonapiKernelTestBase {
  ...
  public function testNormalize(): void {
    ...
    $this->assertSame([
      ...
      'links' => [
        'related' => ['href' => Url::fromUri('internal:/jsonapi/node/article/' . $this->node->uuid() . '/node_type', ['query' => ['resourceVersion' => 'id:' . $this->node->getRevisionId(TRUE)]])->setAbsolute()->toString(TRUE)->getGeneratedUrl()],
        'self' => ['href' => Url::fromUri('internal:/jsonapi/node/article/' . $this->node->uuid() . '/relationships/node_type', ['query' => ['resourceVersion' => 'id:' . $this->node->getRevisionId(TRUE)]])->setAbsolute()->toString(TRUE)->getGeneratedUrl()],
      ],
    ...
    $this->assertEquals([
      ...
      'links' => [
        'self' => ['href' => Url::fromUri('internal:/jsonapi/node/article/' . $this->node->uuid() . '/relationships/uid', ['query' => ['resourceVersion' => 'id:' . $this->node->getRevisionId(TRUE)]])->setAbsolute()->toString(TRUE)->getGeneratedUrl()],
        'related' => ['href' => Url::fromUri('internal:/jsonapi/node/article/' . $this->node->uuid() . '/uid', ['query' => ['resourceVersion' => 'id:' . $this->node->getRevisionId(TRUE)]])->setAbsolute()->toString(TRUE)->getGeneratedUrl()],
      ],
