  ...
  protected function serializeField($field, array $context, $format) {
    ...
    if ($field instanceof FieldItemListInterface) {
      ...
      if ($context['resource_object']->getResourceType()->getDeserializationTargetClass() === 'Drupal\layout_builder\Entity\LayoutBuilderEntityViewDisplay'
        || $context['resource_object']->getResourceType()->getDeserializationTargetClass() === 'Drupal\quickedit\Entity\QuickEditLayoutBuilderEntityViewDisplay') {
        if ($context['resource_object']->getField('third_party_settings') === $field) {
