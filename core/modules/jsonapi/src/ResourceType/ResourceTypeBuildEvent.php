...
class ResourceTypeBuildEvent extends Event {
   ...
   *   The fields of the resource type to be built.
   */
  protected function __construct(string $resource_type_name, array $fields) {
   ...
   *   A new event.
   */
  public static function createFromEntityTypeAndBundle(EntityTypeInterface $entity_type, string $bundle, array $fields) {
   ...
   */
  public function setPublicFieldName(ResourceTypeField $field, string $public_field_name) {
