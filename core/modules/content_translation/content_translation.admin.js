...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.contentTranslation = {
    attach: function attach(context) {
      Drupal.once('translation-entity-admin-hide', $(context).find('table .bundle-settings .translatable :input')).forEach(function (input) {
        var $input = $(input);
      ...
      $(Drupal.once('translation-entity-admin-bind', 'body')).on('click', 'table .bundle-settings .translatable :input', function (e) {
        var $target = $(e.target);
