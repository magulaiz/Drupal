...
/**
 * Tests the has_element process_condition plugin.
 *
 * @group migrate
 * @coversDefaultClass \Drupal\migrate\Plugin\migrate\process\condition\HasElement
 */
class HasElementTest extends UnitTestCase {
  ...
  public function testEvaluate($source, $configuration, $sub_evaluate_map, $expected) {
    ...
    $condition = new HasElement($configuration, 'has_element', [], $process_condition_manager);
  ...
  public function testConstructor() {
    ...
    $condition = new HasElement($configuration, 'has_element', [], $process_condition_manager);
    $this->assertSame(TRUE, $condition->evaluate([123, 456], $row));
    $this->assertSame(FALSE, $condition->evaluate([456, 789], $row));
  }
