...
/**
 * Tests the all_elements process_condition plugin.
 *
 * @group migrate
 * @coversDefaultClass \Drupal\migrate\Plugin\migrate\process\condition\AllElements
 */
class AllElementsTest extends UnitTestCase {
  ...
  public function testEvaluate($source, $configuration, $sub_evaluate_map, $expected) {
    ...
    $condition = new AllElements($configuration, 'all_elements', [], $process_condition_manager);
