...
/**
 * @coversDefaultClass \Drupal\migrate\Plugin\migrate\process\condition\OlderThan
 * @group migrate
 */
  ...
  public function providerTestConfigurationValidation() {
    return [
      [
        ...
        'message' => 'Exactly one of value and property must be set when using the older_than process condition.',
      ],
      [
        'configuration' => [
          'format' => 'U',
      ...
      [
        ...
        'message' => 'The property configuration must be a string when using the older_than process condition.',
      ],
      [
        'configuration' => [
          'value' => 'not a date',
