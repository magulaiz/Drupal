...
use Drupal\migrate\Plugin\migrate\process\condition\InArray;
use Drupal\Tests\UnitTestCase;

/**
 * @coversDefaultClass \Drupal\migrate\Plugin\migrate\process\condition\InArray
 * @group migrate
 */
  ...
  public function providerTestConfigurationValidation() {
    return [
      [
        ...
        'message' => 'Exactly one of value and property must be set when using the in_array process condition.',
      ],
      [
        'configuration' => [],
        'message' => 'Exactly one of value and property must be set when using the in_array process condition.',
      ...
      [
        ...
        'message' => 'The property configuration must be a string when using the in_array process condition.',
      ],
    ];
  }
