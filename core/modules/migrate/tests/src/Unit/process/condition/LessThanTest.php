...
use Drupal\migrate\Plugin\migrate\process\condition\LessThan;
use Drupal\Tests\UnitTestCase;

/**
 * @coversDefaultClass \Drupal\migrate\Plugin\migrate\process\condition\LessThan
 * @group migrate
 */
  ...
  public function providerTestConfigurationValidation() {
    return [
      [
        ...
        'message' => 'Exactly one of value and property must be set when using the less_than process condition.',
      ],
      [
        'configuration' => [],
        'message' => 'Exactly one of value and property must be set when using the less_than process condition.',
      ...
      [
        ...
        'message' => 'The property configuration must be a string when using the less_than process condition.',
      ],
    ];
  }
