...
use Drupal\migrate\Plugin\migrate\condition\HasElement;
 ...
 *
 * @group migrate
 * @coversDefaultClass \Drupal\migrate\Plugin\migrate\condition\HasElement
 */
class HasElementTest extends UnitTestCase {
  ...
  public function testEvaluate($source, $configuration, $sub_evaluate_map, $expected) {
    ...
    $condition = new HasElement($configuration, 'has_element', [], $condition_manager);
