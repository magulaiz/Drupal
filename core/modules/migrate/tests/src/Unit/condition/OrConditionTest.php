...
use Drupal\migrate\Plugin\migrate\condition\OrCondition;
 ...
 *
 * @group migrate
 * @coversDefaultClass \Drupal\migrate\Plugin\migrate\condition\OrCondition
 */
class OrConditionTest extends UnitTestCase {
  ...
  public function testConfigurationValidation($configuration, $message) {
    ...
    $condition = new OrCondition($configuration, 'or', [], $condition_manager);
  }
  ...
  public function providerTestConfigurationValidation() {
    return [
      [
        'configuration' => [],
        'message' => 'The or condition requires configuration.',
      ],
      [
        'configuration' => [
          'key' => 'value',
        ],
        'message' => "The 'configuration' passed to the or condition must be an array or arrays.",
      ],
      [
        'configuration' => [
          [
        ...
        'message' => "Each configuration element passed to the or condition must have the `condition` set.",
      ],
      [
        'configuration' => [
          [
