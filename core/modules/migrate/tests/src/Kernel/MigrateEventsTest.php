...
class MigrateEventsTest extends KernelTestBase {
   ...
   *   The event name.
   */
  public function mapSaveEventRecorder(MigrateMapSaveEvent $event, string $name) {
   ...
   *   The event name.
   */
  public function mapDeleteEventRecorder(MigrateMapDeleteEvent $event, string $name) {
   ...
   *   The event name.
   */
  public function preImportEventRecorder(MigrateImportEvent $event, string $name) {
   ...
   *   The event name.
   */
  public function postImportEventRecorder(MigrateImportEvent $event, string $name) {
   ...
   *   The event name.
   */
  public function preRowSaveEventRecorder(MigratePreRowSaveEvent $event, string $name) {
   ...
   *   The event name.
   */
  public function postRowSaveEventRecorder(MigratePostRowSaveEvent $event, string $name) {
