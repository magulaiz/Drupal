...
class SearchQuery extends SelectExtender {
  ...
  public function prepareAndNormalize() {
    ...
    $this->join('search_total', 't', $this->connection->condition('AND')->compare('i.word', 't.word'));
    $this
    ...
    if (!$this->simple) {
      $normalize_query->join('search_dataset', 'd', $this->connection->condition('AND')->compare('i.sid', 'd.sid')->compare('i.type', 'd.type')->compare('i.langcode', 'd.langcode'));
  ...
  public function execute() {
    ...
    $this->join('search_dataset', 'd', $this->connection->condition('AND')->compare('i.sid', 'd.sid')->compare('i.type', 'd.type')->compare('i.langcode', 'd.langcode'));
    if (count($this->conditions)) {
  ...
  public function countQuery() {
    ...
    $inner->join('search_dataset', 'd', $this->connection->condition('AND')->compare('i.sid', 'd.sid')->compare('i.type', 'd.type'));
    if (count($this->conditions)) {
