...
interface SearchIndexInterface {
   ...
   */
  public function index(string $type, int $sid, string $langcode, string $text, bool $update_weights = TRUE);
   ...
   */
  public function markForReindex(string $type = NULL, int $sid = NULL, string $langcode = NULL);
