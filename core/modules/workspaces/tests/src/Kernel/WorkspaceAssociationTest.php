...
class WorkspaceAssociationTest extends KernelTestBase {
   ...
   */
  protected function assertWorkspaceAssociations(string $entity_type_id, array $expected_latest_revisions, array $expected_all_revisions, array $expected_initial_revisions) {
