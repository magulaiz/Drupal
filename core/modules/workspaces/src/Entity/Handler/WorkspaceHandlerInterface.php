...
interface WorkspaceHandlerInterface {
   ...
   * type. If an entity type is supported, there maybe be further decisions
   * each entity type may make to evaluate if a given entity is appropriate to
   * be tracked in a workspace.
   *
