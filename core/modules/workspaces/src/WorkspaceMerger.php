...
class WorkspaceMerger implements WorkspaceMergerInterface {
   ...
   *   The logger.
   */
  public function __construct(protected EntityTypeManagerInterface $entityTypeManager, protected Connection $database, protected WorkspaceAssociationInterface $workspaceAssociation, protected CacheTagsInvalidatorInterface $cacheTagsInvalidator, protected WorkspaceInterface $source, protected WorkspaceInterface $target, protected ?LoggerInterface $logger = NULL) {
    if ($this->logger === NULL) {
