...
class FilterCombineTest extends ViewsKernelTestBase {
  ...
  public function testNonFieldsRow() {
    ...
    $this->assertEquals('Default: Global: Combine fields filter can only be used on displays that use fields. Set the style or row format for that 
    display to one using fields to use the combine field filter.',reset($errors['default']));
