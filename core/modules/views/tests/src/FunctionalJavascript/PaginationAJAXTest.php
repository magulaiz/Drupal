...
class PaginationAJAXTest extends WebDriverTestBase {
  ...
  public function testBasicPagination() {
    ...
    $this->assertEquals('?view_query=_wrapper_format%3Ddrupal_ajax&status=All&type=All&langcode=All&items_per_page=5&order=changed&sort=asc&wrapper_format=drupal_ajax&title=&page=2', $link->getAttribute('href'));
