...
class PaginationAJAXTest extends WebDriverTestBase {
  ...
  public function testBasicPagination() {
    ...
    $this->assertEquals('?selector=' . $currentAjaxView['selector'] . '&status=All&type=All&langcode=All&items_per_page=5&order=changed&sort=asc&page=2', $link->getAttribute('href'));
