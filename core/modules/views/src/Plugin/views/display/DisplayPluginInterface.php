...
interface DisplayPluginInterface {
   ...
   */
  public function getFieldLabels(bool $groupable_only = FALSE);
   ...
   */
  public function setOverride(string $section, bool $new_state = NULL);
   ...
   */
  public function renderArea(string $area, bool $empty = FALSE);
   ...
   */
  public function buildRenderable(array $args = [], bool $cache = TRUE);
