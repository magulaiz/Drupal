...
class EntityField extends FieldPluginBase implements CacheableDependencyInterface, MultiItemsFieldHandlerInterface, DependentWithRemovalPluginInterface {
   ...
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, protected EntityTypeManagerInterface $entityTypeManager, protected FormatterPluginManager $formatterPluginManager, protected FieldTypePluginManagerInterface $fieldTypePluginManager, protected LanguageManagerInterface $languageManager, protected RendererInterface $renderer, protected EntityRepositoryInterface $entityRepository, EntityFieldManagerInterface $entity_field_manager) {
