...
class ViewPageController {
   ...
   */
  public function handle(string $view_id, string $display_id, RouteMatchInterface $route_match) {
    $args = [];
   ...
   */
  public function getTitle(string $view_id, string $display_id = 'default') {
