...
class LinkFormatterDisplayTest extends LinkFormatterDisplayTestBase {
  ...
  public function testLinkFormatter(): void {
    ...
    foreach ($this->getTestCases() as $case_name => $case_options) {
      ...
      foreach ($expected_results as $delta => $expected_result) {
        ...
        $message = "Test case failed. Case name: '$case_name'. Delta: '$delta'. Uri: '{$this->getTestValues()[$delta]['uri']}'";
  ...
  public function getTestCases(): \Generator {
    $default = [
      ...
      4 => '<div><a href="?b%5B1%5D=1&amp;b%5B0%5D=2">?b%5B1%5D=1&amp;b%5B0%5D=2</a></div>',
    ...
    yield 'trim_length=6' => [
      ...
      'expected_results' => [
        ...
        4 => '<div><a href="?b%5B1%5D=1&amp;b%5B0%5D=2">?b%5B…</a></div>',
    ...
    yield 'attribute rel=nofollow' => [
      ...
      'expected_results' => [
        ...
        4 => '<div><a href="?b%5B1%5D=1&amp;b%5B0%5D=2" rel="nofollow">?b%5B1%5D=1&amp;b%5B0%5D=2</a></div>',
    ...
    yield 'attribute target=_blank' => [
      ...
      'expected_results' => [
        ...
        4 => '<div><a href="?b%5B1%5D=1&amp;b%5B0%5D=2" target="_blank">?b%5B1%5D=1&amp;b%5B0%5D=2</a></div>',
    ...
    yield 'url_only=true, url_plain=true' => [
      ...
      'expected_results' => [
        ...
        4 => '<div>?b%5B1%5D=1&amp;b%5B0%5D=2</div>',
