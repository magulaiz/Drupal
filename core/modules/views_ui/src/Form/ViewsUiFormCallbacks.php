...
class ViewsUiFormCallbacks {
   ...
   */
  #[TrustedCallback]
  public static function formButtonClicked(array &$element, FormStateInterface $form_state) {
   ...
   */
  #[TrustedCallback]
  public static function addLimitedValidation(array &$element, FormStateInterface $form_state) {
