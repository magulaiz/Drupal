...
class ProfileFieldOptionTranslation extends ProfileField {
  ...
  public function query() {
    ...
    $query->leftJoin('i18n_strings', 'i18n', $this->database->condition('AND')->compare('pf.name', 'i18n.objectid'));
    $query->innerJoin('locales_target', 'lt', $this->database->condition('AND')->compare('lt.lid', 'i18n.lid'));
