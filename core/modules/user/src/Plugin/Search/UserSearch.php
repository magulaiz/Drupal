...
class UserSearch extends SearchPluginBase implements AccessibleInterface {
   ...
   */
  public function __construct(protected Connection $database, protected EntityTypeManagerInterface $entityTypeManager, protected ModuleHandlerInterface $moduleHandler, protected AccountInterface $currentUser, array $configuration, $plugin_id, $plugin_definition) {
