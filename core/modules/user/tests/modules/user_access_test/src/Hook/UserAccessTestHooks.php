...
class UserAccessTestHooks
{
     ...
     */
    #[Hook('user_access')]
    public function userAccess(\Drupal\user\Entity\User $entity, $operation, $account)
    {
    ...
    public function entityCreateAccess(\Drupal\Core\Session\AccountInterface $account, array $context, $entity_bundle)
    {
