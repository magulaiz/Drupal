...
class UserAccessTestHooks {
   ...
   */
  #[Hook('user_access')]
    public function userAccessTestUserAccess(User $entity, $operation, $account) {
    ...
    public function userAccessTestEntityCreateAccess(AccountInterface $account, array $context, $entity_bundle) {
    ...
    public function userAccessTestEntityFieldAccess($operation, FieldDefinitionInterface $field_definition, AccountInterface $account, ?FieldItemListInterface $items = \NULL) {
