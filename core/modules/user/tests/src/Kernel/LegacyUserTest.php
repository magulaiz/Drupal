...
class LegacyUserTest extends KernelTestBase {
  ...
  public function testUserLoginDeprecation(): void {
    $this->expectDeprecation("user_login_finalize() is deprecated in drupal:10.3.0 and is removed from drupal:11.0.0. Use Drupal\user\UserSessionHandler::login() instead. See https://www.drupal.org/node/3379194");
  ...
  public function testUserLogoutDeprecation(): void {
    $this->expectDeprecation("user_logout() is deprecated in drupal:10.3.0 and is removed from drupal:11.0.0. Use Drupal\user\UserSessionHandler::logout() instead. See https://www.drupal.org/node/3379194");
    user_logout();
  }
