...
class MigrateUserConfigsTest extends MigrateDrupal6TestBase {
  ...
  public function testUserMail(): void {
    ...
    $this->assertSame('Account details for [user:name] at [site:name] (approved)', $config->get(UserEmailNotification::StatusActivated->value . '.subject'));
    $this->assertSame("[user:name],\n\nYour account at [site:name] has been activated.\n\nYou may now log in by clicking on this link or copying and pasting it in your browser:\n\n[user:one-time-login-url]\n\nThis is a one-time login, so it can be used only once.\n\nAfter logging in, you will be redirected to [user:edit-url] so you can change your password.\n\nOnce you have set your own password, you will be able to log in to [site:login-url] in the future using:\n\nusername: [user:name]\n", $config->get(UserEmailNotification::StatusActivated->value . '.body'));
    $this->assertSame('Replacement login information for [user:name] at [site:name]', $config->get(UserEmailNotification::PasswordReset->value . '.subject'));
    $this->assertSame("[user:name],\n\nA request to reset the password for your account has been made at [site:name].\n\nYou may now log in to [site:url-brief] by clicking on this link or copying and pasting it in your browser:\n\n[user:one-time-login-url]\n\nThis is a one-time login, so it can be used only once. It expires after one day and nothing will happen if it's not used.\n\nAfter logging in, you will be redirected to [user:edit-url] so you can change your password.", $config->get(UserEmailNotification::PasswordReset->value . '.body'));
    $this->assertSame('Account details for [user:name] at [site:name] (deleted)', $config->get(UserEmailNotification::CancelConfirm->value . '.subject'));
    $this->assertSame("[user:name],\n\nYour account on [site:name] has been deleted.", $config->get(UserEmailNotification::CancelConfirm->value . '.body'));
    $this->assertSame('An administrator created an account for you at [site:name]', $config->get(UserEmailNotification::RegisterAdminCreated->value . '.subject'));
    $this->assertSame("[user:name],\n\nA site administrator at [site:name] has created an account for you. You may now log in to [site:login-url] using the following username and password:\n\nusername: [user:name]\npassword: \n\nYou may also log in by clicking on this link or copying and pasting it in your browser:\n\n[user:one-time-login-url]\n\nThis is a one-time login, so it can be used only once.\n\nAfter logging in, you will be redirected to [user:edit-url] so you can change your password.\n\n\n--  [site:name] team", $config->get(UserEmailNotification::RegisterAdminCreated->value . '.body'));
    $this->assertSame('Account details for [user:name] at [site:name]', $config->get(UserEmailNotification::RegisterNoApprovalRequired->value . '.subject'));
    $this->assertSame("[user:name],\n\nThank you for registering at [site:name]. You may now log in to [site:login-url] using the following username and password:\n\nusername: [user:name]\npassword: \n\nYou may also log in by clicking on this link or copying and pasting it in your browser:\n\n[user:one-time-login-url]\n\nThis is a one-time login, so it can be used only once.\n\nAfter logging in, you will be redirected to [user:edit-url] so you can change your password.\n\n\n--  [site:name] team", $config->get(UserEmailNotification::RegisterNoApprovalRequired->value . '.body'));
    $this->assertSame('Account details for [user:name] at [site:name] (pending admin approval)', $config->get(UserEmailNotification::RegisterPendingApproval->value . '.subject'));
    $this->assertSame("[user:name],\n\nThank you for registering at [site:name]. Your application for an account is currently pending approval. Once it has been approved, you will receive another email containing information about how to log in, set your password, and other details.\n\n\n--  [site:name] team", $config->get(UserEmailNotification::RegisterPendingApproval->value . '.body'));
    $this->assertSame('Account details for [user:name] at [site:name] (blocked)', $config->get(UserEmailNotification::StatusBlocked->value . '.subject'));
    $this->assertSame("[user:name],\n\nYour account on [site:name] has been blocked.", $config->get(UserEmailNotification::StatusBlocked->value . '.body'));
    ...
    $this->assertFalse($config->get('notify.' . UserEmailNotification::StatusActivated->value));
