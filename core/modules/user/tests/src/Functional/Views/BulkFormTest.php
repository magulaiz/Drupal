...
class BulkFormTest extends UserTestBase {
  ...
  public function testBulkFormCombineFilter() {
    ...
    $this->assertEquals('Field User: Bulk update set in Global: Combine fields filter is not usable for this filter type. Combined field filter only works for simple fields.'
