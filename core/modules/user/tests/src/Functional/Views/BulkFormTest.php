...
class BulkFormTest extends UserTestBase {
  ...
  public function testBulkFormCombineFilter() {
    ...
    $this->assertEquals('Field <em class="placeholder">User: Bulk update</em> set in <em class="placeholder">Global: Combine fields filter</em> is not usable for this filter type. Combined field filter only works for simple fields.', reset($errors['default']));
  }
