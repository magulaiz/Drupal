...
class TypedConfigTest extends KernelTestBase {
  ...
  public function testTypedDataAPI() {
    ...
    $this->assertEquals(['_core', 'llama', 'cat', 'giraffe', 'uuid', 'langcode', 'string__not_blank', 'string__not_null__not_blank', 'string__not_null__not_blank_allownull', 'required_label'], array_keys($typed_config->getElements()));
