...
class SplitbuttonDeprecationTest extends KernelTestBase {
  ...
  public function testDeprecation() {
    $this->expectDeprecation('Splitbutton using #dropbutton_type is deprecated in drupal:10.1.0 and is removed from drupal:11.0.0. See https://www.drupal.org/node/3169786');
    $this->expectDeprecation('Splitbutton using #links is deprecated in drupal:10.1.0 and is removed from drupal:11.0.0. See https://www.drupal.org/node/3169786');
