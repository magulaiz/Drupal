...
abstract class KernelTestBase extends TestCase implements ServiceProviderInterface {
   ...
   *    replacement.
   *
   * @see https://www.drupal.org/i/3343518
   */
  protected function installEntitySchema($entity_type_id) {
    @trigger_error(__FUNCTION__ . '() is deprecated in drupal:10.1.0 and is removed from drupal:11.0.0. There is no replacement. See https://www.drupal.org/i/3343518', E_USER_DEPRECATED);
