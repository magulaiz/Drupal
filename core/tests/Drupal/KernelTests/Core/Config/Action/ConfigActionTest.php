...
class ConfigActionTest extends KernelTestBase {
  ...
  public function testPlaceBlock(): void {
    ...
    // Define an example set of valid configuration.
    $valid_block = [
      'theme' => 'olivero',
      'region' => 'content',
      'weight' => 0,
    ...
    $default_theme_block = $valid_block;
