...
class ConfigSchemaDeprecationTest extends KernelTestBase {
  ...
  public function testConfigSchemaDeprecation() {
    $this->expectDeprecation('The \'complex_structure_deprecated\' config schema is deprecated in drupal:9.1.0 and is removed from drupal 10.0.0. Use the \'complex_structure\' config schema instead. See https://drupal.org/node/the-change-notice-nid.');
