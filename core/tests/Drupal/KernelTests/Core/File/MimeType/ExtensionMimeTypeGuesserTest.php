...
class ExtensionMimeTypeGuesserTest extends KernelTestBase {
  ...
  public function testFileMimeTypeDetectionCustomMapping(): void {
    ...
    $this->expectDeprecation(
      'Drupal\Core\File\MimeType\ExtensionMimeTypeGuesser::setMapping() is deprecated in drupal:11.1.0 and is removed from drupal:12.0.0. Use \Drupal\Core\File\MimeType\MimeTypeMapInterface::addMapping() instead or define your own MimeTypeMapInterface implementation. See https://www.drupal.org/project/drupal/issues/2311679'
    );
