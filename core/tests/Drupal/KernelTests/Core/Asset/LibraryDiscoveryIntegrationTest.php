...
class LibraryDiscoveryIntegrationTest extends KernelTestBase {
  ...
  public function testLibrariesOverride(): void {
    ...
    $this->assertAssetInLibrary('core/themes/starterkit_theme/css/components/form--inline.css', 'starterkit_theme', 'base', 'css');
    ...
    $this->assertNoAssetInLibrary('core/themes/starterkit_theme/css/components/form--inline.css', 'starterkit_theme', 'base', 'css');
    ...
    $this->assertAssetInLibrary('themes/my_theme/css/my-form--inline.css', 'starterkit_theme', 'base', 'css');
