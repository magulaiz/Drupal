...
class ModuleHandlerDisabledExtensionsTest extends KernelTestBase {
  ...
  public function testLoadIncludeWithDisabledModule() {
    ...
    $this->assertTrue(function_exists('nyan_cat_extension'), 'Module handler unable to include file of uninstalled extensions');
    // Theme extension.
    ...
    $this->assertTrue(function_exists('test_theme_library_info_alter'), 'Module handler unable to include file of uninstalled extensions');
    // Profile extension.
    ...
    $this->assertTrue(function_exists('testing_requirements_requirements'), "Module handler unable to include file of uninstalled extensions");
  }
