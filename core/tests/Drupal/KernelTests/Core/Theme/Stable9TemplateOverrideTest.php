...
class Stable9TemplateOverrideTest extends KernelTestBase {
  ...
  public function testStable9TemplateOverrides(): void {
    $registry = new Registry($this->root, \Drupal::cache(), \Drupal::lock(), \Drupal::moduleHandler(), $this->themeHandler, \Drupal::service('theme.initialization'), \Drupal::service('cache.bootstrap'), \Drupal::service('extension.list.module'), \Drupal::service('kernel'), \Drupal::service('file_system'), 'stable9');
