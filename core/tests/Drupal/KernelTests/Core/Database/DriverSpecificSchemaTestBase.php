...
<<<<<<< HEAD:core/tests/Drupal/KernelTests/Core/Database/SchemaTest.php
=======
use Drupal\Core\Database\Schema;
>>>>>>> upstream/11.x:core/tests/Drupal/KernelTests/Core/Database/DriverSpecificSchemaTestBase.php
