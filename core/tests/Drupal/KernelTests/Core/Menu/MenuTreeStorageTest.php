...
class MenuTreeStorageTest extends KernelTestBase {
  ...
  protected function setUp(): void {
    ...
    $this->treeStorage = new MenuTreeStorage($this->container->get('database'), $this->container->get('cache.menu'), $this->container->get('cache_tags.invalidator'), 'menu_tree', $this->container->get('logger.factory')->get('action'), $this->container->get('database.replica_kill_switch'));
  ...
  protected function doTestTable() {
    ...
    $tree_storage = new MenuTreeStorage($this->container->get('database'), $this->container->get('cache.menu'), $this->container->get('cache_tags.invalidator'), 'test_menu_tree', $this->container->get('logger.factory')->get('action'), $this->container->get('database.replica_kill_switch'));
