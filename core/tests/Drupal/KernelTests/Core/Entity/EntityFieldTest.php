...
class EntityFieldTest extends EntityKernelTestBase {
   ...
   */
  protected function doTestReadWrite(string $entity_type) {
   ...
   *   The entity type to run the tests with.
   */
  protected function doTestSave(string $entity_type) {
    $langcode_key = $this->entityTypeManager->getDefinition($entity_type)->getKey('langcode');
    $entity = $this->createTestEntity($entity_type);
    $entity->save();
   ...
   *   The entity type to run the tests with.
   */
  protected function doTestIntrospection(string $entity_type) {
   ...
   *   The entity type to run the tests with.
   */
  protected function doTestIterator(string $entity_type) {
    $entity = $this->createTestEntity($entity_type);
   ...
   *   The entity type to run the tests with.
   */
  protected function doTestDataStructureInterfaces(string $entity_type) {
    $entity = $this->createTestEntity($entity_type);
   ...
   *   The entity type to run the tests with.
   */
  protected function doTestComputedProperties(string $entity_type) {
    $entity = $this->createTestEntity($entity_type);
