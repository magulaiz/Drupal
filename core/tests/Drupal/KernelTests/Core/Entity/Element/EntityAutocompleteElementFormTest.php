...
class EntityAutocompleteElementFormTest extends EntityKernelTestBase implements FormInterface {
  ...
  public function testInvalidEntityAutocompleteElement() {
    ...
    $this->assertEquals('There are no test entity entities matching "<em class="placeholder">single - non-existent label</em>".', $form_state->getErrors()['single']);
    ...
    $form_builder->submitForm($this, $form_state);
    $this->assertCount(1, $form_state->getErrors());
    $this->assertEquals('The referenced entity (<em class="placeholder">entity_test</em>: <em class="placeholder">42</em>) does not exist.', $form_state->getErrors()['single']);
    ...
    $this->assertCount(1, $form_state->getErrors());
    $this->assertEquals('There are no test entity entities matching "<em class="placeholder">single - non-existent label</em>".', $form_state->getErrors()['single_no_validate']);
