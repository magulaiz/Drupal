...
class ValidReferenceConstraintValidatorTest extends EntityKernelTestBase {
  ...
  public function testPreExistingItemsValidation() {
    ...
    $role_with_access = Role::create(['id' => 'role_with_access', 'label' => $this->randomString()]);
    ...
    $role_without_access = Role::create(['id' => 'role_without_access', 'label' => $this->randomString()]);
