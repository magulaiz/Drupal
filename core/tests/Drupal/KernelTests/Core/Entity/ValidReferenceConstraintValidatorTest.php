...
class ValidReferenceConstraintValidatorTest extends EntityKernelTestBase {
  ...
  public function testValidation() {
    ...
    $this->assertEquals('The referenced entity (user: '.$entity->id().') does not exist.', $violation->getMessage(), 'The message for invalid value is correct.');
  ...
  public function testPreExistingItemsValidation() {
    ...
    $this->assertEquals('This entity (node: '.$unpublished_node->id().') cannot be referenced.',
    ...
    $violations = $referencing_entity->field_test->validate();
    $this->assertCount(1, $violations);
    $this->assertEquals('This entity (node: '.$different_bundle_node->id().') cannot be referenced.', 
    $violations[0]->getMessage());
    ...
    $this->assertEquals('This entity (node: '.$different_bundle_node->id().') cannot be referenced.',
    $violations[0]->getMessage());
    $this->assertEquals('The referenced entity (node: '.$deleted_node->id().') does not exist.',
