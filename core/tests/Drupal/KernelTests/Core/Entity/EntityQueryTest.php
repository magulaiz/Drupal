...
class EntityQueryTest extends EntityKernelTestBase {
  ...
  public function testToString() {
    ...
    $expected->join("entity_test_mulrev__$figures", "entity_test_mulrev__$figures", $connection->condition('AND')->compare('entity_test_mulrev__' . $figures . '.entity_id', 'base_table.id'));
    $expected->join("entity_test_mulrev__$figures", "entity_test_mulrev__{$figures}_2", $connection->condition('AND')->compare('entity_test_mulrev__' . $figures . '_2.entity_id', 'base_table.id'));
    $expected->addJoin("LEFT", "entity_test_mulrev__$figures", "entity_test_mulrev__{$figures}_3", $connection->condition('AND')->compare('entity_test_mulrev__' . $figures . '_3.entity_id', 'base_table.id'));
