...
class EntityRevisionsTest extends EntityKernelTestBase {
  ...
  public function testGetLoadedRevisionIdReturningString(): void {
    $this->expectDeprecation('Returning the loaded revision identifier as a string value is deprecated in drupal:11.1.0 and will be removed in drupal:12.0.0. See https://www.drupal.org/node/3476934');
    $entity = EntityTestMulRev::create();
    $entity->save();
