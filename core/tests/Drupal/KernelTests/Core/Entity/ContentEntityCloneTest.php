...
class ContentEntityCloneTest extends EntityKernelTestBase {
  ...
  public function testEntityPropertiesModifications() {
    ...
    $translation_unique_properties = ['activeLangcode', 'translationInitialize', 'fieldDefinitions', 'languages', 'langcodeKey', 'defaultLangcode', 'defaultLangcodeKey', 'revisionTranslationAffectedKey', 'validated', 'validationRequired', 'entityTypeId', 'typedData', 'cacheContexts', 'cacheTags', 'cacheMaxAge', 'duplicateSource', '_serviceIds', '_entityStorages'];
