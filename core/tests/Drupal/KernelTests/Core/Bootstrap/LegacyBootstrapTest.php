...
class LegacyBootstrapTest extends KernelTestBase {
  ...
  public function testWatchdogException(): void {
    ...
    $this->expectDeprecation('watchdog_exception() is deprecated in drupal:10.0.0 and is removed from drupal:11.0.0. Use \Drupal::logger() and pass the exception as a variable instead. See https://www.drupal.org/node/2932520');
