...
class DatelistElementFormTest extends KernelTestBase implements FormInterface, TrustedCallbackInterface {
  ...
  public function testDatelistElementUntrustedCallbacks() : void {
    ...
    $this->expectExceptionMessage(sprintf('Datelist element #date_date_callbacks callbacks must be methods with the Drupal\Core\Security\Attribute\TrustedCallback attribute, or be methods of a class that implements \Drupal\Core\Security\TrustedCallbackInterface, or be an anonymous function. The callback was %s. See https://www.drupal.org/node/3217966', Variable::callableToString([$this, 'datelistDateCallback'])));
