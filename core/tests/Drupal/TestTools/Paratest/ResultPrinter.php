    ...
    public function printResults(TestResult $testResult, array $teamcityFiles, array $testdoxFiles): void
    {
        ...
        if ($this->options->configuration->outputIsTestDox()) {
            ...
            $defaultResultPrinter = new DefaultResultPrinter(
                ...
                false,
                false,
                $this->options->configuration->displayDetailsOnTestsThatTriggerDeprecations(),   // ----> changed
                $this->options->configuration->displayDetailsOnTestsThatTriggerErrors(),         // ----> changed
                $this->options->configuration->displayDetailsOnTestsThatTriggerNotices(),        // ----> changed
                $this->options->configuration->displayDetailsOnTestsThatTriggerWarnings(),       // ----> changed
                false,
            );
        }
