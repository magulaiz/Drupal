...
namespace Drupal\TestTools\Paratest;
...
use ParaTest\WrapperRunner\ResultPrinter;       // ----> added
use ParaTest\WrapperRunner\SuiteLoader;         // ----> added
use ParaTest\WrapperRunner\WrapperWorker;       // ----> added
...
final class Runner implements RunnerInterface
{
    ...
    public function __construct(
        ...
        $wrapper = realpath(
            // ----> changed
            dirname(__DIR__, 5) . DIRECTORY_SEPARATOR . 'vendor' . DIRECTORY_SEPARATOR . 'brianium' . DIRECTORY_SEPARATOR . 'paratest' . DIRECTORY_SEPARATOR . 'bin' . DIRECTORY_SEPARATOR . 'phpunit-wrapper.php',
        );
