...
abstract class QuickStartTestBase extends BuildTestBase {
   ...
   */
  public function installQuickStart(string $profile, string $working_dir = NULL) {
   ...
   *   workspace directory.
   */
  public function formLogin(string $username, string $password, string $working_dir = NULL) {
