...
trait SchemaCheckTestTrait {
   ...
   */
  public function assertConfigSchema(TypedConfigManagerInterface $typed_config, string $config_name, $config_data) {
   ...
   *   The configuration name.
   */
  public function assertConfigSchemaByName(string $config_name) {
