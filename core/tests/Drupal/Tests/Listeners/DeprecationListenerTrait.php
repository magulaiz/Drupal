...
trait DeprecationListenerTrait {
  ...
  public static function getSkippedDeprecations() {
    return [
      ...
      'Calling Drupal\Core\Extension\ModuleHandlerInterface::getImplementations() directly has been deprecated since Drupal 9.4.0. If you needed this for hook invocations, use Drupal\Core\Extension\ModuleHandlerInterface::invokeAllWith() instead. If you needed this to determine if hook implementations exist, use Drupal\Core\Extension\ModuleHandlerInterface::hasImplementations() instead. You can find more detailed information about this change at https://www.drupal.org/node/3000490.',
