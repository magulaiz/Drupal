...
trait DeprecationListenerTrait {
  ...
  public static function getSkippedDeprecations() {
    return [
      ...
      'Calling Drupal\Core\Extension\ModuleHandlerInterface::getImplementations() directly has been deprecated since Drupal 8.7.0. If you needed this for custom hook invocations, use Drupal\Core\Extension\ModuleHandlerInterface::invoke*With() instead. You can find more detailed information about this change at https://www.drupal.org/node/3000490.',
