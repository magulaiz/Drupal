...
class StorageComparerTest extends UnitTestCase {
  ...
  public function testDeprecatedStorageComparerInterface() {
    $this->expectDeprecation('The Drupal\Core\Config\StorageComparerInterface is deprecated in drupal:11.0.0 and is removed from drupal:12.0.0. Use "StorageComparer" instead. See https://www.drupal.org/project/drupal/issues/3410037');
