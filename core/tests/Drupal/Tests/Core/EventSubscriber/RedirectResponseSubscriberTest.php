...
class RedirectResponseSubscriberTest extends UnitTestCase {
  ...
  public function providerTestDestinationRedirectToExternalUrl() {
    return [
      ...
      'absolute external url with folder2' => [new Request(['destination' => 'https://example.ca/drupal']), 'https://example.ca/drupal'],
  ...
  public function providerTestDestinationRedirectWithInvalidUrl() {
    ...
    $data['absolute external url with folder'] = [new Request(['destination' => 'https://example.ca/drupal'])];
