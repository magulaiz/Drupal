...
class DefaultHtmlRouteProviderTest extends UnitTestCase {
   ...
   */
  public function testGetAddPageRoute(Route $expected = NULL, EntityTypeInterface $entity_type): void {
   ...
   */
  public function testGetAddFormRoute(Route $expected = NULL, EntityTypeInterface $entity_type, EntityTypeInterface $bundle_entity_type = NULL, FieldStorageDefinitionInterface $field_storage_definition = NULL): void {
   ...
   */
  public function testGetCanonicalRoute(Route $expected = NULL, EntityTypeInterface $entity_type, FieldStorageDefinitionInterface $field_storage_definition = NULL): void {
    if ($field_storage_definition) {
   ...
   */
  public function testGetCollectionRoute(Route $expected = NULL, EntityTypeInterface $entity_type): void {
