...
class CacheTagsInvalidatorTest extends UnitTestCase {
  ...
  public function testInvalidateTags() {
    ...
    // Repeat the above for static cache bins.
    $invalidator_static_cache_bin = $this->createMock('\Drupal\Core\Cache\CacheTagsInvalidator');
    $invalidator_static_cache_bin->expects($this->once())
      ->method('invalidateTags')
      ->with(['node:1']);
    $non_invalidator_static_cache_bin = $this->createMock('\Drupal\Core\Cache\CacheBackendInterface');
    ...
    $container->set('cache.invalidator_static_cache_bin', $invalidator_static_cache_bin);
    $container->set('cache.non_invalidator_static_cache_bin', $non_invalidator_static_cache_bin);
    ...
    $container->setParameter('static_cache_bins', ['cache.invalidator_static_cache_bin' => 'invalidator_static_cache_bin', 'cache.non_invalidator_static_cache_bin' => 'non_invalidator_static_cache_bin']);
