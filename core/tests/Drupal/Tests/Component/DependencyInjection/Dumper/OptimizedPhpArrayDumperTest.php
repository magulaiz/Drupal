 ...
 */
#[\PHPUnit\Framework\Attributes\CoversClass(OptimizedPhpArrayDumper::class)]
#[\PHPUnit\Framework\Attributes\Group('DependencyInjection')]
class OptimizedPhpArrayDumperTest extends TestCase {
   ...
   */
  #[\PHPUnit\Framework\Attributes\DataProvider('getAliasesDataProvider')]
   ...
   */
  #[\PHPUnit\Framework\Attributes\DataProvider('getParametersDataProvider')]
   ...
   */
  #[\PHPUnit\Framework\Attributes\DataProvider('getDefinitionsDataProvider')]
   ...
   * @legacy-covers ::getReferenceCall
   */
  #[\PHPUnit\Framework\Attributes\DataProvider('publicPrivateDataProvider')]
   ...
   */
  #[\PHPUnit\Framework\Attributes\DataProvider('percentsEscapeProvider')]
