...
class ElementValidationTest extends WebDriverTestBase {
  ...
  public function testAjaxElementValidation() {
    ...
    $placeholder_text = $assert->waitForElement('css', "[aria-label='Status message'] > div[role='status'] > ul > li > em:contains('some dumb text')");
    ...
    $placeholder_number = $assert->waitForElement('css', "[aria-label='Status message'] > div[role='status'] > ul > li > em:contains('12345')");
