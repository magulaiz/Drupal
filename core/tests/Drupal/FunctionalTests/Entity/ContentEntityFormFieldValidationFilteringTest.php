...
class ContentEntityFormFieldValidationFilteringTest extends BrowserTestBase {
  ...
  public function testFieldWidgetsWithLimitedValidationErrors() {
    ...
    $assert_session->elementsCount('css', 'div#edit-test-multiple-wrapper div.form-type-text input', 1);
    $this->submitForm([], 'Add another item');
    $assert_session->elementsCount('css', 'div#edit-test-multiple-wrapper div.form-type-text input', 2);
