    ...
    attach(context) {
      ...
      once('drupal-tip', '[data-drupal-toggletip]', context).forEach(
        (tipElement) => {
          ...
          tip.innerHTML = Drupal.checkPlain(toggletipConfig.content);
