...
class StaticTrustedCallbackHelper {
   ...
   */
  public static function callback(callable $callback, array $args, string $message, string $error_type = TrustedCallbackInterface::THROW_EXCEPTION, string $extra_trusted_interface = NULL) {
