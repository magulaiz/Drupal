 ...
 *   - If #required is TRUE, this defaults to '' (an empty string). Warning:
 *     the value in #options will be overridden by the value of #empty_option
 *     if #empty_value is set to any value already present in the keys of
 *     #options.
