...
class Renderer implements RendererInterface {
  ...
  protected function doCallback($callback_type, $callback, array $args) {
    ...
    $message = sprintf('Render %s callbacks must be methods with the Drupal\Core\Security\Attribute\TrustedCallback attribute, or be methods of a class that implements \Drupal\Core\Security\TrustedCallbackInterface, or be an anonymous function. The callback was %s. See https://www.drupal.org/node/2966725', $callback_type, '%s');
