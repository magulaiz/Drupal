...
class SiteConfigureForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['update_notifications'] = [
      ...
      '#description' => $this->t('When <a href="@update-module">checking for updates</a>, anonymous information about your site is sent to <a href="@drupal">Drupal.org</a>.', ['@drupal' => 'https://drupal.org', '@update-module' => 'https://www.drupal.org/docs/8/core/modules/update/overview']),
      '#access' => empty($install_state['config_install_path']),
    ];
