...
class SiteConfigureForm extends ConfigFormBase {
   ...
   *   The country manager.
   */
  public function __construct(protected $root, protected $sitePath, UserStorageInterface $user_storage, ModuleInstallerInterface $module_installer, CountryManagerInterface $country_manager) {
