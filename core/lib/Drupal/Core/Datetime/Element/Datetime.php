...
class Datetime extends DateElementBase {
   ...
   * @return string
   *
   * @deprecated in drupal:10.2.0 and is removed from drupal:11.0.0. HTML date
  ...
  public static function formatExample($format) {
    @trigger_error(__METHOD__ . ' is deprecated in drupal:10.2.0 and is removed from drupal:11.0.0. No replacement provided. https://www.drupal.org/project/drupal/issues/2791693', E_USER_DEPRECATED);
