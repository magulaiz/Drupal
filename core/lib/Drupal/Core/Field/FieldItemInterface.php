...
interface FieldItemInterface extends ComplexDataInterface {
   ...
   *
   * @return array
   *   A list of default settings, keyed by the setting name. Setting names defined
   *   by this method must not duplicate the setting names returned by this plugin's
   *   implementation of defaultFieldSettings(), as both lists of settings are merged.
   */
   ...
   *   A list of default settings, keyed by the setting name. Setting names defined
   *   by this method must not duplicate the setting names returned by this plugin's
   *   implementation of defaultStorageSettings(), as both lists of settings are merged.
   */
