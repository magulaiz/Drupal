  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($form_connection_settings = $form_state->getValue('connection_settings')) {
      ...
      try {
        ...
        $form_state->setErrorByName('connection_settings', $this->t('Failed to connect to the server. The server reports the following "message: %message"For more help adding or updating code on your server, see the <a href=":handbook_url">handbook</a>.', [
