...
class ConfigImporter {
   ...
   *   The theme extension list.
   */
  public function __construct(protected StorageComparerInterface $storageComparer, protected EventDispatcherInterface $eventDispatcher, protected ConfigManagerInterface $configManager, protected LockBackendInterface $lock, protected TypedConfigManagerInterface $typedConfigManager, protected ModuleHandlerInterface $moduleHandler, protected ModuleInstallerInterface $moduleInstaller, protected ThemeHandlerInterface $themeHandler, TranslationInterface $string_translation, protected ModuleExtensionList $moduleExtensionList, ThemeExtensionList $extension_list_theme = NULL) {
