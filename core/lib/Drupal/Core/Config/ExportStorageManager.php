...
final class ExportStorageManager implements StorageManagerInterface {
   ...
   */
  public function __construct(protected StorageInterface $active, Connection $connection, protected EventDispatcherInterface $eventDispatcher, protected LockBackendInterface $lock) {
