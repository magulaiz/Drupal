  ...
  protected static array $ignoredPropertyPaths = [
    ...
    'block.block.*' => [
      'settings' => [
        ...
        "'depth' is a required key because plugin is system_menu_block:.* \(see config schema type block\.settings\.system_menu_block:\*.*",
        "'expand_all_items' is a required key because plugin is system_menu_block:.* \(see config schema type block\.settings\.system_menu_block:\*.*",
        "'level' is a required key because plugin is system_menu_block:.* \(see config schema type block\.settings\.system_menu_block:\*.*",
        // @see \Drupal\views\Plugin\Block\ViewsBlock
        "'views_label' is a required key because plugin is views_block:.* \(see config schema type block\.settings\.views_block:\*.*",
        // @see \Drupal\views\Plugin\Block\ViewsExposedFilterBlock
        "'items_per_page' is a required key because plugin is views_block:.* \(see config schema type block\.settings\.views_block:*.*",
        "'items_per_page' is a required key because plugin is views_exposed_filter_block:.* \(see config schema type block\.settings\.views_exposed_filter_block:*.*",
      ],
      'visibility.*' => [
        "'.*' is a required key because visibility\..* is .* \(see config schema type condition\.plugin\..*",
      ],
    ],
    'node.type.*' => [
    ...
    'core.base_field_override.*.*.*' => [
      'settings.handler_settings' => [
        ...
        "'auto_create' is a required key because settings\.handler is default \(see config schema type entity_reference_selection\.default.*",
        "'auto_create_bundle' is a required key because settings\.handler is default \(see config schema type entity_reference_selection\.default.*",
        "'sort' is a required key because settings\.handler is default \(see config schema type entity_reference_selection\.default.*",
        "'target_bundles' is a required key because settings\.handler is default \(see config schema type entity_reference_selection\.default.*",
      ],
      'default_value.*' => [
        "'target_uuid' is a required key because field_type is entity_reference \(see config schema type field.value.entity_reference\).",
      ],
    ],
    'core.entity_form_display.*.*.*' => [
      ...
      'content.*.settings' => [
        "'.*' is a required key because content\..*\.type is .* \(see config schema type field\.widget\.settings\..*",
      ],
    ...
    'core.entity_view_display.*.*.*' => [
      ...
      'content.*.settings' => [
        "'pager_id' is a required key because content\..*\.type is comment_default \(see config schema type field\.formatter\.settings\.comment_default.*",
        "'use_description_as_link_text' is a required key because content\..*\.type is file_default \(see config schema type field\.formatter\.settings\.file_default\).",
        "'image_loading' is a required key because content\..*\.type is image \(see config schema type field\.formatter\.settings\.image\).",
        "'test_formatter_setting' is a required key because content\..*\.type is field_test_default \(see config schema type field.formatter.settings.field_test_default\).",
        "'link_to_entity' is a required key because content\..*\.type is string \(see config schema type field\.formatter\.settings\.string\).",
      ],
      ...
      'third_party_settings.layout_builder.sections.*.components.*.configuration' => [
        ...
        "'status' is a required key.",
        "'context_mapping' is a required key.",
        "'formatter' is a required key because third_party_settings\.layout_builder\.sections\..*\.configuration\.id is extra_field_block:.* \(see config schema type block\.settings\.extra_field_block:\*:\*:\*.*",
      ],
      'third_party_settings.layout_builder.sections.*.components.*.configuration.formatter.settings' => [
        "'link' is a required key because third_party_settings\.layout_builder\.sections\..*\.components\..*\.configuration\.formatter\.type is entity_reference_entity_view \(see config schema type field.formatter.settings.entity_reference_entity_view\).",
      ],
    ],
    'editor.editor.*' => [
      'image_upload' => [
    ...
    'field.field.*.*.*' => [
      'settings' => [
        ...
        "'allowed_formats' is a required key because field_type is text.* \(see config schema type field.field_settings.text.*\).",
      ],
      'settings.handler_settings' => [
        "'target_type' is a required key.",
        // @see \Drupal\Core\Entity\Plugin\EntityReferenceSelection\DefaultSelection
        ...
        "'auto_create' is a required key because settings\.handler is .* \(see config schema type entity_reference_selection\..*",
        "'auto_create_bundle' is a required key because settings\.handler is .* \(see config schema type entity_reference_selection\..*",
        "'sort' is a required key because settings\.handler is .* \(see config schema type entity_reference_selection\..*",
        "'target_bundles' is a required key because settings\.handler is default:.* \(see config schema type entity_reference_selection\.default:.*",
        // @see \Drupal\user\Plugin\EntityReferenceSelection\UserSelection
        "'filter' is a required key because settings\.handler is default:user \(see config schema type entity_reference_selection\.default:user.*",
        "'include_anonymous' is a required key because settings\.handler is default:user \(see config schema type entity_reference_selection\.default:user.*",
        // @see \Drupal\views\Plugin\EntityReferenceSelection\ViewsSelection
        "'view' is a required key because settings\.handler is views \(see config schema type entity_reference_selection\.views.*",

        "'sort' is a required key because settings\.handler is entity_test_all_except_host \(see config schema type entity_reference_selection\.entity_test_all_except_host",
      ],
      ...
      'default_value.*' => [
        ...
        "'target_id' is a required key because field_type is (entity_reference|file|image) \(see config schema type field\.value\..*",
        "'target_uuid' is a required key because field_type is (entity_reference|file|image) \(see config schema type field\.value\..*",
        // @see \Drupal\link\Plugin\Field\FieldType\LinkItem
        "'attributes' is a required key because field_type is link \(see config schema type field\.value\.link.*",
        // @see \Drupal\text\Plugin\Field\FieldType\TextItemBase
        "'format' is a required key because field_type is (text|text_long|text_with_summary) \(see config schema type field\.value\.text.*",
      ],
    ...
    'field.storage.*.*' => [
      'settings' => [
        // @see \Drupal\text\Plugin\Field\FieldType\TextItemBase
        "'allowed_formats' is a required key because type is (text|text_long|text_with_summary) \(see config schema type field\.storage_settings\.text.*",
        // @see \Drupal\Core\Field\Plugin\Field\FieldType\UriItem
        "'is_ascii' is a required key because type is uri \(see config schema type field\.storage_settings\.uri.*",
      ],
    ...
    'filter.format.*' => [
      ...
      'filters.*.settings' => [
        ...
        "'restrictions' is a required key because filters\..*\.id is filter_test_restrict_tags_and_attributes \(see config schema type filter_settings\.filter_test_restrict_tags_and_attributes.*",
      ],
    ],
    ...
    'rest.resource.*' => [
      'configuration' => [
        "'.*' is a required key because granularity is method \(see config schema type rest_resource.method.*",
      ],
      'configuration.GET' => [
    ...
    'tour.tour.*' => [
      ...
      'tips.*' => [
        "'position' is a required key because tips\..*\.plugin is .* \(see config schema type tour\.tip\..*",
        "'selector' is a required key because tips\..*\.plugin is .* \(see config schema type tour\.tip\..*",
      ],
    ],
    'update.settings' => [
      'check' => [
    ...
    'views.view.*' => [
      ...
      'display.*.display_options' => [
        ...
        "'attachment_position' is a required key because display\..*\.display_plugin is attachment \(see config schema type views\.display\.attachment.*",
        "'inherit_arguments' is a required key because display\..*\.display_plugin is attachment \(see config schema type views\.display\.attachment.*",
        "'inherit_exposed_filters' is a required key because display\..*\.display_plugin is attachment \(see config schema type views\.display\.attachment.*",
        "'inherit_pager' is a required key because display\..*\.display_plugin is attachment \(see config schema type views\.display\.attachment.*",
        "'render_pager' is a required key because display\..*\.display_plugin is attachment \(see config schema type views\.display\.attachment.*",
        "'displays' is a required key because display\..*\.display_plugin is attachment \(see config schema type views\.display\.attachment.*",
        // @see \Drupal\rest\Plugin\views\display\RestExport
        "'auth' is a required key because display\..*\.display_plugin is rest_export \(see config schema type views\.display\.rest_export.*",
        // @see \Drupal\views\Plugin\views\display\Block
        "'block_category' is a required key because display\..*\.display_plugin is block \(see config schema type views\.display\.block.*",
        "'block_description' is a required key because display\..*\.display_plugin is block \(see config schema type views\.display\.block.*",
        "'block_hide_empty' is a required key because display\..*\.display_plugin is block \(see config schema type views\.display\.block.*",
        "'block_hide_empty' is a required key because display\..*\.display_plugin is block \(see config schema type views\.display\.block.*",
        "'allow' is a required key because display\..*\.display_plugin is block \(see config schema type views\.display\.block.*",
        // @see \Drupal\views\Plugin\views\display\Feed
        "'displays' is a required key because display\..*\.display_plugin is feed \(see config schema type views\.display\.feed.*",
        "'sitename_title' is a required key because display\..*\.display_plugin is feed \(see config schema type views\.display\.feed.*",
        // @see \Drupal\views\Plugin\views\display\Page
        "'menu' is a required key because display\..*\.display_plugin is (page|invalid) \(see config schema type views\.display\..*",
        "'tab_options' is a required key because display\..*\.display_plugin is (page|invalid) \(see config schema type views\.display\..*",
        "'use_admin_theme' is a required key because display\..*\.display_plugin is (page|invalid) \(see config schema type views\.display\..*",
        ...
        "'path' is a required key because display\..*\.display_plugin is (feed|page|rest_export|invalid) \(see config schema type views\.display\..*",
        "'route_name' is a required key because display\..*\.display_plugin is (feed|page|rest_export|invalid) \(see config schema type views\.display\..*",
        "'test_option' is a required key because display\..*\.display_plugin is display_.* \(see config schema type views.display.*",
      ],
      'display.*.display_options.cache' => [
        // @see \Drupal\views\Plugin\views\cache\Tag
        // @see \Drupal\views\Plugin\views\cache\Time
        "'options' is a required key because display\..*\.cache\.type is .* \(see config schema type views\.cache\..*",
      ],
      ...
      'display.*.display_options.exposed_form.options' => [
        ...
        "'text_input_required_format' is a required key because display\..*\.display_options\.exposed_form\.type is input_required \(see config schema type views.exposed_form.input_required\).",
        "'text_input_required' is a required key because display\..*\.display_options\.exposed_form\.type is input_required \(see config schema type views.exposed_form.input_required\).",
      ],
      ...
      'display.*.display_options.sorts.*' => [
        ...
        "'granularity' is a required key because display\..*\.sorts\..*\.plugin_id is date \(see config schema type views\.sort\.date.*",
      ],
      'display.*.display_options.header.*' => [
        ...
        "'tokenize' is a required key because display\..*\.header\..*\.plugin_id is (entity|text|text_custom) \(see config schema type views\.area\..*",
        // @see \Drupal\views\Plugin\views\area\Text
        // @see \Drupal\views\Plugin\views\area\TextCustom
        "'content' is a required key because display\..*\.header\..*\.plugin_id is (text|text_custom) \(see config schema type views\.area\.text.*",
        // @see \Drupal\views\Plugin\views\area\Entity
        "'bypass_access' is a required key because display\..*\.header\..*\.plugin_id is entity \(see config schema type views\.area\.entity.*",
        // @see \Drupal\views_test_data\Plugin\views\area\TestExample
        "'custom_access' is a required key because display\..*\.header\..*\.plugin_id is test_example \(see config schema type views\.area\.test_example.*",
        "'string' is a required key because display\..*\.header\..*\.plugin_id is test_example \(see config schema type views\.area\.test_example.*",
      ],
      ...
      'display.*.display_options.pager.options' => [
        ...
        "'expose' is a required key because display\..*\.pager\.type is full \(see config schema type views\.pager\.full.*",
        "'id' is a required key because display\..*\.pager\.type is full \(see config schema type views\.pager\.full.*",
        "'quantity' is a required key because display\..*\.pager\.type is full \(see config schema type views\.pager\.full.*",
        "'tags' is a required key because display\..*\.pager\.type is full \(see config schema type views\.pager\.full.*",
        "'total_pages' is a required key because display\..*\.pager\.type is full \(see config schema type views\.pager\.full.*",
        // @see \Drupal\views\Plugin\views\pager\Mini
        "'expose' is a required key because display\..*\.pager\.type is mini \(see config schema type views\.pager\.mini.*",
        "'id' is a required key because display\..*\.pager\.type is mini \(see config schema type views\.pager\.mini.*",
        "'tags' is a required key because display\..*\.pager\.type is mini \(see config schema type views\.pager\.mini.*",
        "'total_pages' is a required key because display\..*\.pager\.type is mini \(see config schema type views\.pager\.mini.*",
      ],
      'display.*.display_options.query.options' => [
        // @see \Drupal\views\Plugin\views\query\Sql
        "'disable_sql_rewrite' is a required key because display\..*\.query\.type is views_query \(see config schema type views\.query\.views_query.*",
        "'distinct' is a required key because display\..*\.query\.type is views_query \(see config schema type views\.query\.views_query.*",
        "'query_comment' is a required key because display\..*\.query\.type is views_query \(see config schema type views\.query\.views_query.*",
        "'query_tags' is a required key because display\..*\.query\.type is views_query \(see config schema type views\.query\.views_query.*",
        "'replica' is a required key because display\..*\.query\.type is views_query \(see config schema type views\.query\.views_query.*",
      ],
      'display.*.display_options.empty.*' => [
        ...
        // @see \Drupal\views\Plugin\views\area\Text
        // @see \Drupal\views\Plugin\views\area\TextCustom
        "'content' is a required key because display\..*\.empty\..*\.plugin_id is (text|text_custom) \(see config schema type views\.area\.text.*",
        // @see \Drupal\views\Plugin\views\area\TokenizeAreaPluginBase
        // @see \Drupal\views\Plugin\views\area\Entity (inherited)
        // @see \Drupal\views\Plugin\views\area\Text (inherited)
        // @see \Drupal\views\Plugin\views\area\TextCustom (inherited)
        "'tokenize' is a required key because display\..*\.empty\..*\.plugin_id is (entity|text|text_custom) \(see config schema type views\.area\..*",
        // @see \Drupal\views\Plugin\views\area\Entity
        "'bypass_access' is a required key because display\..*\.empty\..*\.plugin_id is entity \(see config schema type views\.area\.entity.*",
        "'view_mode' is a required key because display\..*\.empty\..*\.plugin_id is entity \(see config schema type views\.area\.entity.*",
        // @see \Drupal\views_test_data\Plugin\views\area\TestExample
        "'custom_access' is a required key because display\..*\.empty\..*\.plugin_id is test_example \(see config schema type views\.area\.test_example.*",
        "'string' is a required key because display\..*\.empty\..*\.plugin_id is test_example \(see config schema type views\.area\.test_example.*",
      ],
      'display.*.display_options.arguments.*' => [
        ...
        "'must_not_be' is a required key because display\..*\.arguments\..*\.plugin_id is null \(see config schema type views\.argument\.null.*",
        ...
        "'not' is a required key because display\..*\.arguments\..*\.plugin_id is (numeric|file_fid|number_list_field|node_nid|node_uid_revision|node_vid|taxonomy|vocabulary_vid|user_uid) \(see config schema type views\.argument\..*",
        ...
        "'date' is a required key because display\..*\.arguments\..*\.plugin_id is (date|date_day|date_fulldate|date_month|date_week|date_year|date_year_month|date_year_month|datetime|datetime_day|datetime_full_date|datetime_month|datetime_week|datetime_year_month|datetime_year) \(see config schema type views\.argument\.date.*",
        "'node_created' is a required key because display\..*\.arguments\..*\.plugin_id is (date|date_day|date_fulldate|date_month|date_week|date_year|date_year_month|date_year_month|datetime|datetime_day|datetime_full_date|datetime_month|datetime_week|datetime_year_month|datetime_year) \(see config schema type views\.argument\.date.*",
        "'node_changed' is a required key because display\..*\.arguments\..*\.plugin_id is (date|date_day|date_fulldate|date_month|date_week|date_year|date_year_month|date_year_month|datetime|datetime_day|datetime_full_date|datetime_month|datetime_week|datetime_year_month|datetime_year) \(see config schema type views\.argument\.date.*",
        // @see \Drupal\views\Plugin\views\argument\DayDate
        // @see \Drupal\datetime\Plugin\views\argument\DayDate (inherited)
        "'day' is a required key because display\..*\.arguments\..*\.plugin_id is (date_day|datetime_day) \(see config schema type views\.argument\.date.*",
        // @see \Drupal\views\Plugin\views\argument\MonthDate
        // @see \Drupal\datetime\Plugin\views\argument\MonthDate (inherited)
        "'month' is a required key because display\..*\.arguments\..*\.plugin_id is (date_month|datetime_month) \(see config schema type views\.argument\.date.*",
        // @see \Drupal\views\Plugin\views\argument\YearMonthDate
        // @see \Drupal\datetime\Plugin\views\argument\YearMonthDate (inherited)
        // @see \Drupal\views\Plugin\views\argument\FullDate
        // @see \Drupal\datetime\Plugin\views\argument\FullDate (inherited)
        "'created' is a required key because display\..*\.arguments\..*\.plugin_id is (date_year_month|datetime_year_month|date_fulldate|datetime_fulldate) \(see config schema type views\.argument\.date.*",
        ...
        "'add_table' is a required key because display\..*\.arguments\..*\.plugin_id is (string|node_type|string_list_field) \(see config schema type views\.argument\..*",
        "'require_value' is a required key because display\..*\.arguments\..*\.plugin_id is (string|node_type|string_list_field) \(see config schema type views\.argument\..*",
      ],
      ...
      'display.*.display_options.arguments.*.validate_options' => [
        ...
        "'bundles' is a required key because display\..*\.arguments\..*\.validate\.type is (entity:.*|taxonomy_term_name|user_name) \(see config schema type views\.argument_validator\..*",
        "'multiple' is a required key because display\..*\.arguments\..*\.validate\.type is (entity:.*|taxonomy_term_name|user_name) \(see config schema type views\.argument_validator\..*",
        // @see \Drupal\taxonomy\Plugin\views\argument_validator\TermName
        "'vids' is a required key because display\..*\.arguments\..*\.validate\.type is taxonomy_term_name \(see config schema type views\.argument_validator\.taxonomy_term_name.*",
      ],
      ...
      'display.*.display_options.arguments.*.summary_options' => [
        ...
        "'base_path' is a required key because display\..*\.arguments\..*\.summary\.format is (default_summary|unformatted_summary) \(see config schema type views\.style\..*",
        "'count' is a required key because display\..*\.arguments\..*\.summary\.format is (default_summary|unformatted_summary) \(see config schema type views\.style\..*",
        "'items_per_page' is a required key because display\..*\.arguments\..*\.summary\.format is (default_summary|unformatted_summary) \(see config schema type views\.style\..*",
        "'override' is a required key because display\..*\.arguments\..*\.summary\.format is (default_summary|unformatted_summary) \(see config schema type views\.style\..*",
      ],
      ...
      'display.*.display_options.footer.*' => [
        ...
        // @see \Drupal\views\Plugin\views\area\Text (inherited)
        // @see \Drupal\views\Plugin\views\area\TextCustom (inherited)
        "'tokenize' is a required key because display\..*\.footer\..*\.plugin_id is (entity|text|text_custom) \(see config schema type views\.area\..*",
        // @see \Drupal\views\Plugin\views\area\Text
        // @see \Drupal\views\Plugin\views\area\TextCustom
        "'content' is a required key because display\..*\.footer\..*\.plugin_id is (text|text_custom) \(see config schema type views\.area\.text.*",
        // @see \Drupal\views\Plugin\views\area\Entity
        "'bypass_access' is a required key because display\..*\.footer\..*\.plugin_id is entity \(see config schema type views\.area\..*",
        // @see \Drupal\views_test_data\Plugin\views\area\TestExample
        "'custom_access' is a required key because display\..*\.footer\..*\.plugin_id is test_example \(see config schema type views\.area\.test_example.*",
        "'string' is a required key because display\..*\.footer\..*\.plugin_id is test_example \(see config schema type views\.area\.test_example.*",
      ],
      'display.*.display_options.fields.*' => [
        ...
        "'link_to_user' is a required key because display\..*\.fields\..*\.plugin_id is user \(see config schema type views\.field\.user.*",
        // @see \Drupal\comment\Plugin\views\field\NodeNewComments
        "'format_plural' is a required key because display\..*\.fields\..*\.plugin_id is node_new_comments \(see config schema type views\.field\.node_new_comments.*",
        "'format_plural_string' is a required key because display\..*\.fields\..*\.plugin_id is node_new_comments \(see config schema type views\.field\.node_new_comments.*",
        "'separator' is a required key because display\..*\.fields\..*\.plugin_id is node_new_comments \(see config schema type views\.field\.node_new_comments.*",
        // @see \Drupal\dblog\Plugin\views\field\DblogMessage
        "'replace_variables' is a required key because display\..*\.fields\..*\.plugin_id is dblog_message \(see config schema type views\.field\.dblog_message.*",
        // @see \Drupal\node\Plugin\views\field\Node
        "'link_to_node' is a required key because display\..*\.fields\..*\.plugin_id is node \(see config schema type views\.field\.node.*",
        ...
        "'action_title' is a required key because display\..*\.fields\..*\.plugin_id is (bulk_form|comment_bulk_form|node_bulk_form|user_bulk_form) \(see config schema type views\.field\..*",
        "'include_exclude' is a required key because display\..*\.fields\..*\.plugin_id is (bulk_form|comment_bulk_form|node_bulk_form|user_bulk_form) \(see config schema type views\.field\..*",
        "'selected_actions' is a required key because display\..*\.fields\..*\.plugin_id is (bulk_form|comment_bulk_form|node_bulk_form|user_bulk_form) \(see config schema type views\.field\..*",
        // @see \Drupal\views\Plugin\views\field\NumericField
        "'decimal' is a required key because display\..*\.fields\..*\.plugin_id is numeric \(see config schema type views\.field\.numeric.*",
        "'format_plural' is a required key because display\..*\.fields\..*\.plugin_id is numeric \(see config schema type views\.field\.numeric.*",
        "'format_plural_string' is a required key because display\..*\.fields\..*\.plugin_id is numeric \(see config schema type views\.field\.numeric.*",
        "'precision' is a required key because display\..*\.fields\..*\.plugin_id is numeric \(see config schema type views\.field\.numeric.*",
        "'prefix' is a required key because display\..*\.fields\..*\.plugin_id is numeric \(see config schema type views\.field\.numeric.*",
        "'separator' is a required key because display\..*\.fields\..*\.plugin_id is numeric \(see config schema type views\.field\.numeric.*",
        "'set_precision' is a required key because display\..*\.fields\..*\.plugin_id is numeric \(see config schema type views\.field\.numeric.*",
        "'suffix' is a required key because display\..*\.fields\..*\.plugin_id is numeric \(see config schema type views\.field\.numeric.*",
        // @see \Drupal\views\Plugin\views\field\EntityField
        // @see \Drupal\taxonomy\Plugin\views\field\TermName (inherited)
        "'click_sort_column' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name) \(see config schema type views\.field\..*",
        "'delta_first_last' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name) \(see config schema type views\.field\..*",
        "'delta_limit' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name) \(see config schema type views\.field\..*",
        "'delta_offset' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name) \(see config schema type views\.field\..*",
        "'delta_reversed' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name) \(see config schema type views\.field\..*",
        "'field_api_classes' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name) \(see config schema type views\.field\..*",
        "'group_column' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name) \(see config schema type views\.field\..*",
        "'group_columns' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name) \(see config schema type views\.field\..*",
        "'group_rows' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name) \(see config schema type views\.field\..*",
        "'multi_type' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name) \(see config schema type views\.field\..*",
        "'separator' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name) \(see config schema type views\.field\..*",
        "'settings' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name) \(see config schema type views\.field\..*",
        "'type' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name|boolean) \(see config schema type views\.field\..*",
        "'type_custom_false' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name|boolean) \(see config schema type views\.field\..*",
        "'type_custom_true' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name|boolean) \(see config schema type views\.field\..*",
        "'not' is a required key because display\..*\.fields\..*\.plugin_id is (field|term_name|boolean) \(see config schema type views\.field\..*",
        ...
        "'absolute' is a required key because display\..*\.fields\..*\.plugin_id is (entity_link|entity_link_delete|entity_link_edit) \(see config schema type views\.field\.entity_link.*",
        "'output_url_as_text' is a required key because display\..*\.fields\..*\.plugin_id is (entity_link|entity_link_delete|entity_link_edit) \(see config schema type views\.field\.entity_link.*",
        ...
        "'text' is a required key because display\..*\.fields\..*\.plugin_id is .* \(see config schema type views\.field\..*",
      ],
      ...
      'display.*.display_options.fields.*.settings' => [
        ...
        "'image_loading' is a required key because display\..*\.fields\..*\.type is (image|media_thumbnail) \(see config schema type field\.formatter\.settings\..*",
        // @see \Drupal\views\Plugin\views\field\EntityField
        // @see \Drupal\Core\Field\Plugin\Field\FieldFormatter\TimestampFormatter
        "'time_diff' is a required key because display\..*\.fields\..*\.type is timestamp \(see config schema type field\.formatter\.settings\.timestamp.*",
        "'tooltip' is a required key because display\..*\.fields\..*\.type is timestamp \(see config schema type field\.formatter\.settings\.timestamp.*",
        // @see \Drupal\views\Plugin\views\field\EntityField
        ...
        "'link_to_entity' is a required key because display\..*\.fields\..*\.type is (string|language|user_name) \(see config schema type field\.formatter\.settings\..*",
        // @see \Drupal\views\Plugin\views\field\EntityField
        // @see \Drupal\file\Plugin\Field\FieldFormatter\DefaultFileFormatter
        "'link_to_file' is a required key because display\..*\.fields\..*\.type is file_link \(see config schema type field\.formatter\.settings\.file_link.*",
        // @see \Drupal\views\Plugin\views\field\EntityField
        // @see \Drupal\Core\Field\Plugin\Field\FieldFormatter\TimestampAgoFormatter
        "'future_format' is a required key because display\..*\.fields\..*\.type is timestamp_ago \(see config schema type field\.formatter\.settings\.timestamp_ago.*",
        "'granularity' is a required key because display\..*\.fields\..*\.type is timestamp_ago \(see config schema type field\.formatter\.settings\.timestamp_ago.*",
        "'past_format' is a required key because display\..*\.fields\..*\.type is timestamp_ago \(see config schema type field\.formatter\.settings\.timestamp_ago.*",
      ],
      ...
      'display.*.display_options.filters.*' => [
        ...
        "'type' is a required key because display\..*\.filters\..*\.plugin_id is .* \(see config schema type views\.filter\..*",
        // @see \Drupal\user\Plugin\views\filter\Roles
        "'reduce_duplicates' is a required key because display\..*\.filters\..*\.plugin_id is .* \(see config schema type views\.filter\..*",
        "'hierarchy' is a required key because display\..*\.filters\..*\.plugin_id is .* \(see config schema type views\.filter\..*",
        "'limit' is a required key because display\..*\.filters\..*\.plugin_id is .* \(see config schema type views\.filter\..*",
        "'error_message' is a required key because display\..*\.filters\..*\.plugin_id is .* \(see config schema type views\.filter\..*",
      ],
      ...
      'display.*.display_options.filters.*.group_info.group_items.*.value' => [
        ...
        // @see \Drupal\datetime\Plugin\views\filter\Date (inherited)
        "'min' is a required key because display\..*\.filters\..*\.plugin_id is (numeric|date|groupby_numeric|comment_ces_last_updated|datetime) \(see config schema type views\.filter_value\..*",
        "'max' is a required key because display\..*\.filters\..*\.plugin_id is (numeric|date|groupby_numeric|comment_ces_last_updated|datetime) \(see config schema type views\.filter_value\..*",
        "'value' is a required key because display\..*\.filters\..*\.plugin_id is (numeric|date|groupby_numeric|comment_ces_last_updated|datetime) \(see config schema type views\.filter_value\..*",
      ],
      'display.*.display_options.filters.*.value' => [
        // @see \Drupal\views\Plugin\views\filter\Date
        // @see \Drupal\datetime\Plugin\views\filter\Date (inherited)
        "'type' is a required key because display\..*\.filters\..*\.plugin_id is (date|datetime) \(see config schema type views\.filter_value\.date.*",
        // @see \Drupal\views\Plugin\views\filter\NumericFilter
        // @see \Drupal\views\Plugin\views\filter\Date (inherited)
        // @see \Drupal\views\Plugin\views\filter\GroupByNumeric (inherited)
        // @see \Drupal\comment\Plugin\views\filter\StatisticsLastUpdated (inherited)
      ...
      'display.*.display_options.style.options' => [
        ...
        "'alignment' is a required key because display\..*\.style\.type is grid_responsive \(see config schema type views\.style\.grid_responsive.*",
        "'cell_min_width' is a required key because display\..*\.style\.type is grid_responsive \(see config schema type views\.style\.grid_responsive.*",
        "'columns' is a required key because display\..*\.style\.type is grid_responsive \(see config schema type views\.style\.grid_responsive.*",
        "'grid_gutter' is a required key because display\..*\.style\.type is grid_responsive \(see config schema type views\.style\.grid_responsive.*",
        // @see \Drupal\views\Plugin\views\style\Table
        "'caption' is a required key because display\..*\.style\.type is table \(see config schema type views\.style\.table.*",
        "'columns' is a required key because display\..*\.style\.type is table \(see config schema type views\.style\.table.*",
        "'default' is a required key because display\..*\.style\.type is table \(see config schema type views\.style\.table.*",
        "'description' is a required key because display\..*\.style\.type is table \(see config schema type views\.style\.table.*",
        "'empty_table' is a required key because display\..*\.style\.type is table \(see config schema type views\.style\.table.*",
        "'info' is a required key because display\..*\.style\.type is table \(see config schema type views\.style\.table.*",
        "'order' is a required key because display\..*\.style\.type is table \(see config schema type views\.style\.table.*",
        "'override' is a required key because display\..*\.style\.type is table \(see config schema type views\.style\.table.*",
        "'sticky' is a required key because display\..*\.style\.type is table \(see config schema type views\.style\.table.*",
        "'summary' is a required key because display\..*\.style\.type is table \(see config schema type views\.style\.table.*",
      ],
      ...
      'display.*.display_options.row.options' => [
        ...
        "'default_field_elements' is a required key because display\..*\.row\.type is fields \(see config schema type views\.row\.fields.*",
        "'hide_empty' is a required key because display\..*\.row\.type is fields \(see config schema type views\.row\.fields.*",
        "'inline' is a required key because display\..*\.row\.type is fields \(see config schema type views\.row\.fields.*",
        "'separator' is a required key because display\..*\.row\.type is fields \(see config schema type views\.row\.fields.*",
        // @see \Drupal\comment\Plugin\views\row\Rss
        "'view_mode' is a required key because display\..*\.row\.type is .* \(see config schema type views\.row\..*",
      ],
    ...
    'workflows.workflow.*' => [
      'type_settings' => [
        "'default_moderation_state' is a required key because type is content_moderation \(see config schema type workflow\.type_settings\.content_moderation.*",
      ],
