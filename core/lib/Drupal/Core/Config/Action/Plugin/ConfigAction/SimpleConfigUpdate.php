...
final class SimpleConfigUpdate implements ConfigActionPluginInterface, ContainerFactoryPluginInterface {
  ...
  public function apply(string $configName, mixed $value): void {
    if ($this->configManager->getEntityTypeIdByName($configName)) {
      ...
      @trigger_error('Using the simpleConfigUpdate config action is deprecated in drupal:11.2.0 and removed in drupal:12.0.0. Use the setNested action instead. See https://drupal.org/node/3439713.', E_USER_DEPRECATED);
    }
