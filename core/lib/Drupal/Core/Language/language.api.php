 ...
 */
function hook_language_switch_links_alter(array &$links, string $type, \Drupal\Core\Url $url) {
 ...
 * @ingroup hooks
 */
function hook_transliteration_overrides_alter(&$overrides, string $langcode) {
