...
interface StreamWrapperManagerInterface {
   ...
   *   $filter are returned.
   */
  public function getWrappers(int $filter = StreamWrapperInterface::ALL);
   ...
   */
  public function getNames(int $filter = StreamWrapperInterface::ALL);
   ...
   */
  public function getDescriptions(int $filter = StreamWrapperInterface::ALL);
   ...
   */
  public function registerWrapper(string $scheme, string $class, int $type);
