 ...
 *
 * @internal
 *   These methods are necessary for a StreamWrapper manager to implement however
 *   unlike methods on StreamWrapperManagerInterface these methods generally
 *   should only be invoked by Drupal Core and not third parties.
 */
