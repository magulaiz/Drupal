...
class MailManager extends DefaultPluginManager implements MailManagerInterface {
   ...
   *   The renderer.
   */
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler, protected ConfigFactoryInterface $configFactory, protected LoggerChannelFactoryInterface $loggerFactory, TranslationInterface $string_translation, protected RendererInterface $renderer) {
