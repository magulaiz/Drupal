...
interface AuthenticationCollectorInterface {
   ...
   *   Defaults to FALSE.
   */
  public function addProvider(AuthenticationProviderInterface $provider, string $provider_id, int $priority = 0, bool $global = FALSE);
   ...
   */
  public function isGlobal(string $provider_id);
