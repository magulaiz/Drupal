...
class CountryManager implements CountryManagerInterface {
  ...
  /**
   * Convert an array of countries two-letter to three-letter  ISO 3166-1 alpha-2 =>  ISO 3166-1 alpha-3.
   *
   * @return array
