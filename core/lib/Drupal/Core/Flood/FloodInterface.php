...
interface FloodInterface {
   ...
   */
  public function register(string $name, $window = 3600, string $identifier = NULL);
   ...
   */
  public function isAllowed(string $name, $threshold, $window = 3600, string $identifier = NULL);
