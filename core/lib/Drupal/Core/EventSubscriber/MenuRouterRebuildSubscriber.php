...
class MenuRouterRebuildSubscriber implements EventSubscriberInterface {
   ...
   *   The logger.
   */
  public function __construct(protected LockBackendInterface $lock, protected MenuLinkManagerInterface $menuLinkManager, protected Connection $connection, protected ReplicaKillSwitch $replicaKillSwitch, protected ?LoggerInterface $logger = NULL) {
    if ($this->logger === NULL) {
