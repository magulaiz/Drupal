...
class BundleConstraint extends SymfonyConstraint {
  ...
  public function getBundleOption() {
    ...
    if (!is_array($this->bundle)) {
      @trigger_error("The Bundle's constraint's support for string values for its 'bundle' option is deprecated in drupal:10.3.0 and will trigger a PHP error from drupal:11.0.0. Pass in an array of valid string values instead. See https://www.drupal.org/node/1337", E_USER_DEPRECATED);
