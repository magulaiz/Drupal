...
class DefaultSelection extends SelectionPluginBase implements ContainerFactoryPluginInterface, SelectionWithAutocreateInterface {
   ...
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, protected EntityTypeManagerInterface $entityTypeManager, protected ModuleHandlerInterface $moduleHandler, protected AccountInterface $currentUser, protected EntityFieldManagerInterface $entityFieldManager, public EntityTypeBundleInfoInterface $entityTypeBundleInfo = NULL, protected EntityRepositoryInterface $entityRepository) {
