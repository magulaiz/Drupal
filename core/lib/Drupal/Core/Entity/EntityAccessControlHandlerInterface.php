...
interface EntityAccessControlHandlerInterface {
   ...
   */
  public function access(EntityInterface $entity, string $operation, AccountInterface $account = NULL, bool $return_as_object = FALSE);
   ...
   *   access is either explicitly forbidden or "no opinion".
   */
  public function createAccess(string $entity_bundle = NULL, AccountInterface $account = NULL, array $context = [], bool $return_as_object = FALSE);
   ...
   */
  public function fieldAccess(string $operation, FieldDefinitionInterface $field_definition, AccountInterface $account = NULL, FieldItemListInterface $items = NULL, bool $return_as_object = FALSE);
