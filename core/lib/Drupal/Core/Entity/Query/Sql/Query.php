...
class Query extends QueryBase implements QueryInterface {
  ...
  protected function prepare() {
    ...
    if ($this->latestRevision && $revision_field) {
      $this->sqlQuery->leftJoin($base_table, 'base_table_2', $this->sqlQuery->joinCondition()->compare("base_table.$id_field", "base_table_2.$id_field")->compare("base_table.$revision_field", "base_table_2.$revision_field", '<'));
