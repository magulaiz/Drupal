 ...
 *   see the entity.node.canonical route in node.routing.yml for an example,
 *   and see
 ...
 */
function hook_entity_view_mode_info_alter(array &$view_modes) {
 ...
 */
function hook_entity_bundle_info_alter(array &$bundles) {
 ...
 * @ingroup entity_crud
 */
function hook_entity_display_build_alter(array &$build, array $context) {
 ...
 */
function hook_entity_base_field_info_alter(array &$fields, \Drupal\Core\Entity\EntityTypeInterface $entity_type) {
 ...
 * https://www.drupal.org/node/2346347.
 */
function hook_entity_bundle_field_info_alter(array &$fields, \Drupal\Core\Entity\EntityTypeInterface $entity_type, $bundle) {
 ...
 * @see hook_entity_field_storage_info()
 */
function hook_entity_field_storage_info_alter(array &$fields, \Drupal\Core\Entity\EntityTypeInterface $entity_type) {
 ...
 */
function hook_entity_extra_field_info_alter(array &$info) {
