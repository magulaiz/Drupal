 ...
 *   and see @ref sec_routes below for some notes.
 ...
 *   - If linking to entities of your content entity type should happen with
 *   URLs other than the canonical one, or if it does not have a route where it
 *   can be viewed, then a link_target handler should be implemented.
 *   At minimum, provide a link_target.view handler: a class implementing
