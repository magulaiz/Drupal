 ...
 */
function hook_entity_duplicate_create(\Drupal\Core\Entity\EntityInterface $entity) {
 ...
 */
function hook_ENTITY_TYPE_duplicate_create(\Drupal\Core\Entity\EntityInterface $entity) {
