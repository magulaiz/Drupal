...
class FormClass extends EntityTypeProperty {
  ...
  public function __construct(
    ...
    parent::__construct(['handlers', 'form', $operation], $formClass);
  }
  ...
  public function addToDefinition(object|array $definition): EntityTypeInterface {
    ...
    return $definition->setFormClass($this->operation, $this->formClass);
  }
