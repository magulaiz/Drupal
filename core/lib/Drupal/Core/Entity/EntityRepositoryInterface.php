...
interface EntityRepositoryInterface {
   ...
   */
  public function getActive(string $entity_type_id, int|string $entity_id, array $contexts = NULL);
   ...
   *   An entity object variant or NULL if the entity does not exist.
   */
  public function getCanonical(string $entity_type_id, int|string $entity_id, array $contexts = NULL);
