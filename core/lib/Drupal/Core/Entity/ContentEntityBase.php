...
abstract class ContentEntityBase extends EntityBase implements \IteratorAggregate, ContentEntityInterface, TranslationStatusInterface {
  ...
  public function &__get($name) {
    ...
    if (isset($this->fields[$name][$this->activeLangcode])) {
      @trigger_error('Accessing fields (' . $name . ') as properties on content entities is deprecated in drupal:10.0.0 and will be removed before drupal:11.0.0. Instead, use ::get(). See https://www.drupal.org/node/1', E_USER_DEPRECATED);
    ...
    if (isset($this->fieldDefinitions[$name])) {
      @trigger_error('Accessing fields (' . $name . ') on content entities is deprecated in drupal:10.0.0 and will be removed before drupal:11.0.0. Instead, use ::get(). See https://www.drupal.org/node/1', E_USER_DEPRECATED);
    ...
    if (!in_array($name, ['pass_raw', 'passRaw', 'sessionId', '_referringItem', '_skipProtectedUserFieldConstraint', 'view', '_restSubmittedFields', 'book', 'depth', 'rdf_data', '_serviceId', 'preview_view_mode', 'homepage', '_initialPublished', 'in_preview', 'preview'])) {
      @trigger_error('Accessing arbitrary properties (' . $name . ') on content entities is deprecated in drupal:10.0.0 and will be removed before drupal:11.0.0. Instead, use X. See https://www.drupal.org/node/1', E_USER_DEPRECATED);
    }
  ...
  public function __set($name, $value) {
    ...
    if (isset($this->fieldDefinitions[$name])) {
      @trigger_error('Setting a field value as a property (' . $name . ') on content entities is deprecated in drupal:10.0.0 and will be removed before drupal:11.0.0. Instead, use ::set(). See https://www.drupal.org/node/1', E_USER_DEPRECATED);
    ...
    // Directly write non-field values.
      ...
      if (!in_array($name, ['pass_raw', 'passRaw', 'sessionId', '_referringItem', '_skipProtectedUserFieldConstraint', 'view', '_restSubmittedFields', 'book', 'depth', 'rdf_data', '_serviceId', 'preview_view_mode', 'homepage', '_initialPublished', 'in_preview', 'preview'])) {
        @trigger_error('Setting arbitrary properties (' . $name . ') on content entities is deprecated in drupal:10.0.0 and will be removed before drupal:11.0.0. Instead, use X. See https://www.drupal.org/node/1', E_USER_DEPRECATED);
      }
  ...
  public function __isset($name) {
    ...
    if (!in_array($name, ['pass_raw', 'passRaw', 'sessionId', '_referringItem', '_skipProtectedUserFieldConstraint', 'view', '_restSubmittedFields', 'book', 'depth', 'rdf_data', '_serviceId', 'preview_view_mode', 'homepage', '_initialPublished', 'in_preview', 'preview'])) {
      @trigger_error('Checking for an undefined property (' . $name . ') with isset() on content entities is deprecated in drupal:10.0.0 and will be removed before drupal:11.0.0. Instead, use ::set(). See https://www.drupal.org/node/1', E_USER_DEPRECATED);
    }
  ...
  public function __unset($name) {
    ...
    if ($this->hasField($name)) {
      @trigger_error('Unsetting a field (' . $name . ') on content entities is deprecated in drupal:10.0.0 and will be removed before drupal:11.0.0. Instead, use ::set(). See https://www.drupal.org/node/1', E_USER_DEPRECATED);
      $this->get($name)->setValue([]);
    }
    // For non-field properties, unset the internal value.
    else {
      if (!in_array($name, ['pass_raw', 'passRaw', 'sessionId', '_referringItem', '_skipProtectedUserFieldConstraint', 'view', '_restSubmittedFields', 'book', 'depth', 'rdf_data', '_serviceId', 'preview_view_mode', 'homepage', '_initialPublished', 'in_preview', 'preview'])) {
        @trigger_error('Unsetting an undefined property (' . $name . ') on content entities is deprecated in drupal:10.0.0 and will be removed before drupal:11.0.0. Instead, use ::set(). See https://www.drupal.org/node/1', E_USER_DEPRECATED);
      }
