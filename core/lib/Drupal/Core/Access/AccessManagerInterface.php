...
interface AccessManagerInterface {
   ...
   */
  public function checkNamedRoute(string $route_name, array $parameters = [], AccountInterface $account = NULL, bool $return_as_object = FALSE);
   ...
   *   access is either explicitly forbidden or "no opinion".
   */
  public function checkRequest(Request $request, AccountInterface $account = NULL, bool $return_as_object = FALSE);
   ...
   *   access is either explicitly forbidden or "no opinion".
   */
  public function check(RouteMatchInterface $route_match, AccountInterface $account = NULL, Request $request = NULL, bool $return_as_object = FALSE);
