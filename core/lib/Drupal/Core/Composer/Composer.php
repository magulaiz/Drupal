...
class Composer {
  ...
  public static function upgradePHPUnit(Event $event) {
    ...
    // If the PHP version is 8.5 or above and PHPUnit is less than version 11
  ...
  public static function upgradePHPUnitCheck($phpunit_version) {
    return !(version_compare(PHP_MAJOR_VERSION . '.' . PHP_MINOR_VERSION, '8.5') >= 0 && version_compare($phpunit_version, '11.0') < 0);
  }
