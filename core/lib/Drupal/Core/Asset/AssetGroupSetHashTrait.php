...
trait AssetGroupSetHashTrait {
  ...
  protected function generateHash(array $group): string {
    ...
    // The xxh64 hash algorithm is being used here because a cryptographic hash
    // isn't necessary for the data integrity check required here. It's also a
    // lot quicker than the base64 encoded sha-256 hash generated by
    // Crypt::hmacBase64().
