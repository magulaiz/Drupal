...
interface AssetResolverInterface {
   ...
   */
  public function getCssAssets(AttachedAssetsInterface $assets, bool $optimize, LanguageInterface $language = NULL);
   ...
   */
  public function getJsAssets(AttachedAssetsInterface $assets, bool $optimize, LanguageInterface $language = NULL);
