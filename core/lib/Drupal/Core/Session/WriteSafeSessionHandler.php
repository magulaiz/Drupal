 ...
 */
class WriteSafeSessionHandler extends SessionHandlerProxy implements \SessionHandlerInterface, WriteSafeSessionHandlerInterface {

  /**
   * @deprecated in drupal:10.0.0 and is removed from drupal:11.0.0. Use
   *   $handler property instead. Replace see before commit.
   *
