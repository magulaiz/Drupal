...
abstract class Connection {
   ...
   *
   * @param int $options
   *   (Optional) The options to be passed on to debug_backtrace(). Defaults to
   *   DEBUG_BACKTRACE_PROVIDE_OBJECT.
   * @param int $limit
   *   (Optional) A limit for the number of stack frames returned. By default
   *   (limit=0) returns all stack frames.
   *
   * @return array
   ...
   */
  public function findCallerFromDebugBacktrace(int $options = DEBUG_BACKTRACE_PROVIDE_OBJECT, int $limit = 0): array {
    $stack = $this->removeDatabaseEntriesFromDebugBacktrace($this->getDebugBacktrace($options, $limit), $this->getConnectionOptions()['namespace']);
   ...
   *
   * @param int $options
   *   The options to be passed on to debug_backtrace().
   * @param int $limit
   *   A limit for the number of stack frames returned. $limit = 0 returns all
   *   stack frames.
   *
   * @return array[]
   *   The debug backtrace.
   ...
   */
  protected function getDebugBacktrace(int $options, int $limit): array {
