...
trait StatementIteratorTrait {
  ...
  public function rewind(): void {
    ...
    // attempted.
    // @todo convert the assert to an exception in Drupal 11.
    assert($this->resultsetKey < 0, 'Attempted rewinding a StatementInterface object when fetching has already started. Refactor your code to avoid rewinding statement objects.');
