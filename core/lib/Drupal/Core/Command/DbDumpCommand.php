...
class DbDumpCommand extends DbCommandBase {
  ...
  protected function configure(): void {
    $this->setName('dump-database-d8-mysql')
      ...
      ->addOption('schema-only', NULL, InputOption::VALUE_OPTIONAL, 'A comma separated list of tables to only export the schema without data.', 'cache.*,file_cache,sessions,watchdog')
