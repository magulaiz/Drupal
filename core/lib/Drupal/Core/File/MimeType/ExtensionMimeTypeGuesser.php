...
class ExtensionMimeTypeGuesser implements MimeTypeGuesserInterface {
  ...
  protected $defaultMapping = [
    ...
    'mimetypes' => [
      ...
      366 => 'application/vnd.oasis.opendocument.graphics-flat-xml',
