...
interface FileSystemInterface {
   ...
   * @ingroup php_wrappers
   */
  public function chmod(string $uri, int $mode = NULL);
   ...
   */
  public function mkdir(string $uri, int $mode = NULL, bool $recursive = FALSE, $context = NULL);
   ...
   */
  public function copy(string $source, string $destination, int $replace = self::EXISTS_RENAME);
   ...
   */
  public function saveData(string $data, string $destination, int $replace = self::EXISTS_RENAME);
   ...
   *   otherwise.
   */
  public function prepareDirectory(string &$directory, int $options = self::MODIFY_PERMISSIONS);
   ...
   *   Implementation may throw FileException or its subtype on failure.
   */
  public function getDestinationFilename(string $destination, int $replace);
