 ...
 * update.php.
 *
 * The requirements is not limited to runtime or install requirements
 * but can also be used for more general status information like maintenance
 * tasks and security issues.
 * The returned 'requirements' will be listed on the status report in the
 * administration section, with indication of the severity level.
 ...
 */
function hook_requirements_check(): array {
  $requirements = [];
 ...
 *
 * Implementations are able to alter the title, value, description or the
 * severity of certain requirements defined by hook_requirements_check()
 * implementations or even remove such entries.
 *
 * @param array $requirements
 *   The requirements data to be altered.
 *
 * @see hook_requirements_check()
 */
function hook_requirements_check_alter(array &$requirements): void {
  // Change the title from 'PHP' to 'PHP version'.
  $requirements['php']['title'] = t('PHP version');
