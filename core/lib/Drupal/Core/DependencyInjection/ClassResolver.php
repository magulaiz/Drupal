...
class ClassResolver implements ClassResolverInterface {
  ...
  public function getInstanceFromDefinition($definition) {
    ...
    if ($instance instanceof ContainerAwareInterface) {
      @trigger_error(sprintf('Implementing %s is deprecated in drupal:10.3.0 and it will be removed in drupal:11.0.0. Implement %s and use dependency injection instead. See https://www.drupal.org/node/1234567', ContainerAwareInterface::class, ContainerInjectionInterface::class), E_USER_DEPRECATED);
