...
interface MenuParentFormSelectorInterface {
   ...
   */
  public function getParentSelectOptions(string $id = '', array $menus = NULL, CacheableMetadata &$cacheability = NULL);
   ...
   *   by a ':' character.
   */
  public function parentSelectElement(string $menu_parent, string $id = '', array $menus = NULL);
