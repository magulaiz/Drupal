...
class LocalActionManager extends DefaultPluginManager implements LocalActionManagerInterface {
  ...
  protected function alterDefinitions(&$definitions) {
    $this->moduleHandler->alterDeprecated('Deprecated in drupal:9.3.0 and is removed from drupal:10.1.0. Use hook_local_actions_alter instead. See https://www.drupal.org/node/3216578', 'menu_local_actions', $definitions);
