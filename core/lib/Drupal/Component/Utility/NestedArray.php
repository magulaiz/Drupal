...
class NestedArray {
   ...
   */
  public static function arrayWalkNested(array &$array, callable $callback): void {
    self::arrayWalkNestedRecursive($array, $callback, []);
  }
   ...
   */
  protected static function arrayWalkNestedRecursive(array &$array, callable $callback, array $parents): void {
    foreach ($array as $key => &$value) {
