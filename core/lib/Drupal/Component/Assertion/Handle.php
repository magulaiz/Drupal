...
@trigger_error(__NAMESPACE__ . '\Handle is deprecated in drupal:9.4.0 and is removed from drupal:10.0.0. Instead, use assert_options(ASSERT_EXCEPTION, TRUE). See https://drupal.org/node/3105918', E_USER_DEPRECATED);
