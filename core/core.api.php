 ...
 * @endcode
 *
 * Form elements of type 'managed_file' will have an additional 'element_parents'
 * query parameter in Ajax POST requests. This parameter will include the name of
 * the element and its parents as per the render array. This helps to identify the
 * position of the element in the form (See \Drupal\file\Element\ManagedFile).
 * @code
 * 'options' => [
 *   'query' => [
