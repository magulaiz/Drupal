#!/bin/bash
# This script deletes unnecessary directories and files for "production" env
#
# It is meant to be run at the project base and should be run before packaging
# the Drupal application for production.
#
