 ...
 *
 * Normally, Drupal normalizes '/./' and '/../' segments in file URIs to prevent
 * unintended file access. For example, 'private://css/../image.png'
 ...
 * list the schemes here.
 * For example, if 'example://example_path/./filename.png' should not be 
 * normalized to 'example://example_path/filename.png', then add 'example' to
 ...
 * directory tree.
 */
# $settings['file_sa_core_2023_005_schemes'] = ['example'];
