...
'INSERT INTO "key_value" ("name", "collection", "value") VALUES ("twig_extension_hash_prefix", "state", "a:2:{s:19:"twig_extension_hash";s:43:"_yN9CXvsnzT5Y9HaqjpE73ozmvQNr7ZbyNaQ7Uum_rU";s:17:"twig_cache_prefix";s:13:"66f3cf9f46f1d";}")',
...
'SELECT 1 FROM "key_value" WHERE "collection" = "entity_autocomplete" AND "name" = "uvO5I0PhVWvLxfo0eE5lfKDpwwIDHpZWtegLS6V1f24"',
'SELECT 1 AS "expression" FROM "key_value" "key_value" WHERE ("name" = "uvO5I0PhVWvLxfo0eE5lfKDpwwIDHpZWtegLS6V1f24") AND ("collection" = "entity_autocomplete")',
'INSERT INTO "key_value" ("name", "collection", "value") VALUES ("uvO5I0PhVWvLxfo0eE5lfKDpwwIDHpZWtegLS6V1f24", "entity_autocomplete", "a:5:{s:14:"target_bundles";a:1:{s:4:"tags";s:4:"tags";}s:4:"sort";a:1:{s:5:"field";s:5:"_none";}s:11:"auto_create";b:1;s:14:"match_operator";s:8:"CONTAINS";s:11:"match_limit";i:10;}")',
...
'SELECT 1 FROM "key_value" WHERE "collection" = "entity_autocomplete" AND "name" = "SK2DW717tYJSj3KZZN9ygnPoF3bs6ndZrdIb8X5xM6s"',
'SELECT 1 AS "expression" FROM "key_value" "key_value" WHERE ("name" = "SK2DW717tYJSj3KZZN9ygnPoF3bs6ndZrdIb8X5xM6s") AND ("collection" = "entity_autocomplete")',
'INSERT INTO "key_value" ("name", "collection", "value") VALUES ("SK2DW717tYJSj3KZZN9ygnPoF3bs6ndZrdIb8X5xM6s", "entity_autocomplete", "a:2:{s:14:"match_operator";s:8:"CONTAINS";s:11:"match_limit";i:10;}")',
...
'INSERT INTO "semaphore" ("name", "value", "expire") VALUES ("state:Drupal\Core\Cache\CacheCollector", "LOCK_ID", "EXPIRE")',
'DELETE FROM "semaphore"  WHERE ("name" = "state:Drupal\Core\Cache\CacheCollector") AND ("value" = "LOCK_ID")',
'SELECT "base_table"."id" AS "id", "base_table"."path" AS "path", "base_table"."alias" AS "alias", "base_table"."langcode" AS "langcode" FROM "path_alias" "base_table" WHERE ("base_table"."status" = 1) AND ("base_table"."alias" LIKE "/sites/simpletest/23370915/files/js/js\_d8nmhhfrH2EM2kS4INpm57db2nPSYfYRCk0gS1Rimj8.js" ESCAPE \'\\\\\') AND ("base_table"."langcode" IN ("en", "und")) ORDER BY "base_table"."langcode" ASC, "base_table"."id" DESC',
'SELECT "name", "value" FROM "key_value" WHERE "name" IN ( "routing.menu_masks.router" ) AND "collection" = "state"',
'SELECT "name", "route", "fit" FROM "router" WHERE "pattern_outline" IN ( "/sites/simpletest/23370915/files/js/js_d8nmhhfrh2em2ks4inpm57db2npsyfyrck0gs1rimj8.js", "/sites/simpletest/23370915/files/js/%", "/sites/simpletest/23370915/files/%/js_d8nmhhfrh2em2ks4inpm57db2npsyfyrck0gs1rimj8.js", "/sites/simpletest/%/files/%/js_d8nmhhfrh2em2ks4inpm57db2npsyfyrck0gs1rimj8.js", "/sites/simpletest/%/%/%/js_d8nmhhfrh2em2ks4inpm57db2npsyfyrck0gs1rimj8.js", "/sites/%/23370915/%/js/%", "/sites/simpletest/23370915/files/js", "/sites/simpletest/23370915/files/%", "/sites/simpletest/23370915/%/js", "/sites/simpletest/23370915/%/%", "/sites/simpletest/23370915/files/js/%"0, "/sites/simpletest/23370915/files/js/%"1, "/sites/simpletest/23370915/files/js/%"2, "/sites/simpletest/23370915/files/js/%"3, "/sites/simpletest/23370915/files/js/%"4, "/sites/simpletest/23370915/files/js/%"5, "/sites/simpletest/23370915/files/js/%"6, "/sites/simpletest/23370915/files/js/%"7, "/sites/simpletest/23370915/files/js/%"8, "/sites/simpletest/23370915/files/js/%"9, "/sites/simpletest/23370915/files/%/js_d8nmhhfrh2em2ks4inpm57db2npsyfyrck0gs1rimj8.js"0, "/sites/simpletest/23370915/files/%/js_d8nmhhfrh2em2ks4inpm57db2npsyfyrck0gs1rimj8.js"1, "/sites/simpletest/23370915/files/%/js_d8nmhhfrh2em2ks4inpm57db2npsyfyrck0gs1rimj8.js"2, "/sites/simpletest/23370915/files/%/js_d8nmhhfrh2em2ks4inpm57db2npsyfyrck0gs1rimj8.js"3 ) AND "number_parts" >= 6',
'SELECT "name", "value" FROM "key_value" WHERE "name" IN ( "system.maintenance_mode" ) AND "collection" = "state"',
'SELECT "name", "value" FROM "key_value" WHERE "name" IN ( "routing.non_admin_routes" ) AND "collection" = "state"',
'SELECT "name", "value" FROM "key_value" WHERE "name" IN ( "system.private_key" ) AND "collection" = "state"',
'SELECT "name", "value" FROM "key_value" WHERE "name" IN ( "drupal.test_wait_terminate" ) AND "collection" = "state"',
