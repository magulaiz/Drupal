...
class DemoUmamiProfileTest extends BrowserTestBase {
   ...
   *   The database driver override configuration storage to check.
   * @param \Drupal\Core\Config\StorageInterface $active_config_storage
   *   The active configuration storage.
   */
  protected function assertDefaultConfig(StorageInterface $default_config_storage, StorageInterface $override_config_storage, StorageInterface $active_config_storage): void {
    ...
    foreach ($default_config_storage->listAll() as $config_name) {
      ...
      elseif ($active_config_storage->exists($config_name)) {
