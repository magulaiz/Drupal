...
class TwigHooks {
   ...
   *   An instance of the Twig environment used for templating.
   */
  ...
  public function renderTemplate(string $template_file, array $variables): MarkupInterface|string {
    try {
